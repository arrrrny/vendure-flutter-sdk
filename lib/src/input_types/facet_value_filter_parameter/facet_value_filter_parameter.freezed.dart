...
@JsonKey(name: '_and') List<FacetValueFilterParameter>? get and;@JsonKey(name: '_or') List<FacetValueFilterParameter>? get or; StringOperators? get code; DateOperators? get createdAt; IdOperators? get facetId; IdOperators? get id; StringOperators? get languageCode; StringOperators? get name; DateOperators? get updatedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FacetValueFilterParameter&&const DeepCollectionEquality().equals(other.and, and)&&const DeepCollectionEquality().equals(other.or, or)&&(identical(other.code, code) || other.code == code)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.facetId, facetId) || other.facetId == facetId)&&(identical(other.id, id) || other.id == id)&&(identical(other.languageCode, languageCode) || other.languageCode == languageCode)&&(identical(other.name, name) || other.name == name)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(and),const DeepCollectionEquality().hash(or),code,createdAt,facetId,id,languageCode,name,updatedAt);
...
class _FacetValueFilterParameter extends FacetValueFilterParameter {
  const _FacetValueFilterParameter({@JsonKey(name: '_and') final  List<FacetValueFilterParameter>? and, @JsonKey(name: '_or') final  List<FacetValueFilterParameter>? or, this.code, this.createdAt, this.facetId, this.id, this.languageCode, this.name, this.updatedAt}): _and = and,_or = or,super._();
...
@override@JsonKey(name: '_and') List<FacetValueFilterParameter>? get and {
  final value = _and;
...
@override@JsonKey(name: '_or') List<FacetValueFilterParameter>? get or {
  final value = _or;
  if (value == null) return null;
...
@override final  IdOperators? facetId;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FacetValueFilterParameter&&const DeepCollectionEquality().equals(other._and, _and)&&const DeepCollectionEquality().equals(other._or, _or)&&(identical(other.code, code) || other.code == code)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.facetId, facetId) || other.facetId == facetId)&&(identical(other.id, id) || other.id == id)&&(identical(other.languageCode, languageCode) || other.languageCode == languageCode)&&(identical(other.name, name) || other.name == name)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_and),const DeepCollectionEquality().hash(_or),code,createdAt,facetId,id,languageCode,name,updatedAt);
...
as List<FacetValueFilterParameter>?,or: freezed == or ? _self._or : or // ignore: cast_nullable_to_non_nullable
as List<FacetValueFilterParameter>?,code: freezed == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
as StringOperators?,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateOperators?,facetId: freezed == facetId ? _self.facetId : facetId // ignore: cast_nullable_to_non_nullable
as IdOperators?,id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
