...
class _Seller extends Seller {
  const _Seller({required this.createdAt, final  Map<String, dynamic>? customFields, required this.id, required this.name, required this.updatedAt}): _customFields = customFields,super._();
