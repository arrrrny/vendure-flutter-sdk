...
ShippingMethodTranslation _$ShippingMethodTranslationFromJson(Map json) =>
    $checkedCreate('ShippingMethodTranslation', json, ($checkedConvert) {
      final val = ShippingMethodTranslation(
...
Map<String, dynamic> _$ShippingMethodTranslationToJson(
  ShippingMethodTranslation instance,
) => <String, dynamic>{
