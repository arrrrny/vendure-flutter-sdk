...
class _ProductVariantTranslation extends ProductVariantTranslation {
  const _ProductVariantTranslation({required this.createdAt, required this.id, required this.languageCode, required this.name, required this.updatedAt}): super._();
