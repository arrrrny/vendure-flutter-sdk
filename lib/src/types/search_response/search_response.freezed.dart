...
/// Create a copy of SearchResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? collections = null,Object? facetValues = null,Object? items = null,Object? totalItems = null,}) {
  return _then(_self.copyWith(
collections: null == collections ? _self.collections : collections // ignore: cast_nullable_to_non_nullable
as List<CollectionResult>,facetValues: null == facetValues ? _self.facetValues : facetValues // ignore: cast_nullable_to_non_nullable
as List<FacetValueResult>,items: null == items ? _self.items : items // ignore: cast_nullable_to_non_nullable
as List<SearchResult>,totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _SearchResponse extends SearchResponse {
  const _SearchResponse({required final  List<CollectionResult> collections, required final  List<FacetValueResult> facetValues, required final  List<SearchResult> items, required this.totalItems}): _collections = collections,_facetValues = facetValues,_items = items,super._();
...
/// Create a copy of SearchResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? collections = null,Object? facetValues = null,Object? items = null,Object? totalItems = null,}) {
...
as List<CollectionResult>,facetValues: null == facetValues ? _self._facetValues : facetValues // ignore: cast_nullable_to_non_nullable
as List<FacetValueResult>,items: null == items ? _self._items : items // ignore: cast_nullable_to_non_nullable
as List<SearchResult>,totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
