...
RelationCustomFieldConfig _$RelationCustomFieldConfigFromJson(
    Map<String, dynamic> json) {
  return _RelationCustomFieldConfig.fromJson(json);
}
...
/// @nodoc
abstract class $RelationCustomFieldConfigCopyWith<$Res> {
  factory $RelationCustomFieldConfigCopyWith(RelationCustomFieldConfig value,
          $Res Function(RelationCustomFieldConfig) then) =
...
class _$RelationCustomFieldConfigCopyWithImpl<$Res,
        $Val extends RelationCustomFieldConfig>
    implements $RelationCustomFieldConfigCopyWith<$Res> {
  _$RelationCustomFieldConfigCopyWithImpl(this._value, this._then);
...
class __$$RelationCustomFieldConfigImplCopyWithImpl<$Res>
    extends _$RelationCustomFieldConfigCopyWithImpl<$Res,
...
abstract class _RelationCustomFieldConfig extends RelationCustomFieldConfig {
  ...
  factory _RelationCustomFieldConfig.fromJson(Map<String, dynamic> json) =
