...
import 'package:vendure/src/types/order_state_transition_error/order_state_transition_error.dart';
...
class TransitionOrderToStateResult with _$TransitionOrderToStateResult {
  ...
  const factory TransitionOrderToStateResult.orderStateTransitionError({
    ErrorCode? errorCode,
    String? fromState,
    String? message,
    String? toState,
  ...
  factory TransitionOrderToStateResult.fromJson(Map<String, dynamic> json) =>
      _$TransitionOrderToStateResultFromJson(json);
}
