...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DateListOperators&&(identical(other.inList, inList) || other.inList == inList));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DateListOperators&&(identical(other.inList, inList) || other.inList == inList));
}
