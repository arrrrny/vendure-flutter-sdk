...
void main() {
  final String endpoint = TestConfig.shopApiUrl;
  final String username = TestConfig.shopEmail;
  final String password = TestConfig.shopPassword;

  test(
    'VendureSchemaUtils.discoverEnums should discover and register enums',
    () async {
    ...
    ''';
      ...
      final authResult = await authClient.mutate(
        MutationOptions(
      ...
      final token = authResult.context
      ...
      final data = {'currencyCode': 'USD', 'languageCode': 'en'};
      ...
      expect(
        ...
        equals('usd'),
      ); // Should be lowercase if converted
