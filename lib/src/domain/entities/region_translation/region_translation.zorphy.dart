...
class RegionTranslation {
  ...
  RegionTranslation copyWithRegionTranslation({
    DateTime? createdAt,
    String? id,
    LanguageCode? languageCode,
    String? name,
  ...
  RegionTranslation patchWithRegionTranslation([
    RegionTranslationPatch? patchInput,
  ]) {
    final _patcher = patchInput ?? RegionTranslationPatch();
    final _patchMap = _patcher.patchMap;
    return RegionTranslation(
      createdAt: _patchMap.containsKey(RegionTranslation$.createdAt)
          ? (_patchMap[RegionTranslation$.createdAt] is Function)
                ? _patchMap[RegionTranslation$.createdAt](this.createdAt)
                : (_patchMap[RegionTranslation$.createdAt] is Patch)
                ? _patchMap[RegionTranslation$.createdAt].applyTo(
                    this.createdAt,
                  )
                : _patchMap[RegionTranslation$.createdAt]
          : this.createdAt,
      id: _patchMap.containsKey(RegionTranslation$.id)
          ? (_patchMap[RegionTranslation$.id] is Function)
                ? _patchMap[RegionTranslation$.id](this.id)
                : (_patchMap[RegionTranslation$.id] is Patch)
                ? _patchMap[RegionTranslation$.id].applyTo(this.id)
                : _patchMap[RegionTranslation$.id]
          : this.id,
      languageCode: _patchMap.containsKey(RegionTranslation$.languageCode)
          ? (_patchMap[RegionTranslation$.languageCode] is Function)
                ? _patchMap[RegionTranslation$.languageCode](this.languageCode)
                : (_patchMap[RegionTranslation$.languageCode] is Patch)
                ? _patchMap[RegionTranslation$.languageCode].applyTo(
                    this.languageCode,
                  )
                : _patchMap[RegionTranslation$.languageCode]
          : this.languageCode,
      name: _patchMap.containsKey(RegionTranslation$.name_)
          ? (_patchMap[RegionTranslation$.name_] is Function)
                ? _patchMap[RegionTranslation$.name_](this.name)
                : (_patchMap[RegionTranslation$.name_] is Patch)
                ? _patchMap[RegionTranslation$.name_].applyTo(this.name)
                : _patchMap[RegionTranslation$.name_]
          : this.name,
      updatedAt: _patchMap.containsKey(RegionTranslation$.updatedAt)
          ? (_patchMap[RegionTranslation$.updatedAt] is Function)
                ? _patchMap[RegionTranslation$.updatedAt](this.updatedAt)
                : (_patchMap[RegionTranslation$.updatedAt] is Patch)
                ? _patchMap[RegionTranslation$.updatedAt].applyTo(
                    this.updatedAt,
                  )
                : _patchMap[RegionTranslation$.updatedAt]
          : this.updatedAt,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is RegionTranslation &&
  ...
  Map<String, dynamic> toJsonLean() {
    final Map<String, dynamic> data = _$RegionTranslationToJson(this);
...
extension RegionTranslationPropertyHelpers on RegionTranslation {
...
extension RegionTranslationSerialization on RegionTranslation {
  Map<String, dynamic> toJson() {
    return _$RegionTranslationToJson(this);
  }
}

enum RegionTranslation$ { createdAt, id, languageCode, name_, updatedAt }

class RegionTranslationPatch
    extends PatchBase<RegionTranslation, RegionTranslation$> {
  RegionTranslation applyTo(RegionTranslation entity) {
    return entity.patchWithRegionTranslation(this);
  }

  RegionTranslationPatch withCreatedAt(DateTime? value) {
    patchMap[RegionTranslation$.createdAt] = value;
    return this;
  }

  RegionTranslationPatch withId(String? value) {
    patchMap[RegionTranslation$.id] = value;
    return this;
  }

  RegionTranslationPatch withLanguageCode(LanguageCode? value) {
    patchMap[RegionTranslation$.languageCode] = value;
    return this;
  }

  RegionTranslationPatch withName(String? value) {
    patchMap[RegionTranslation$.name_] = value;
    return this;
  }

  RegionTranslationPatch withUpdatedAt(DateTime? value) {
    patchMap[RegionTranslation$.updatedAt] = value;
    return this;
  }
}

/// Field descriptors for [RegionTranslation] query construction
abstract final class RegionTranslationFields {
  static const createdAt = Field<RegionTranslation, DateTime?>(
    'createdAt',
    _$createdAt,
  );

  static const id = Field<RegionTranslation, String?>('id', _$id);

  static const languageCode = Field<RegionTranslation, LanguageCode?>(
    'languageCode',
    _$languageCode,
  );

  static const name = Field<RegionTranslation, String?>('name', _$name);

  static const updatedAt = Field<RegionTranslation, DateTime?>(
    'updatedAt',
    _$updatedAt,
  );

  static DateTime? _$createdAt(RegionTranslation e) {
    return e.createdAt;
  }

  static String? _$id(RegionTranslation e) {
    return e.id;
  }

  static LanguageCode? _$languageCode(RegionTranslation e) {
    return e.languageCode;
  }

  static String? _$name(RegionTranslation e) {
    return e.name;
  }

  static DateTime? _$updatedAt(RegionTranslation e) {
    return e.updatedAt;
  }
}

extension RegionTranslationCompareE on RegionTranslation {
  Map<String, dynamic> compareToRegionTranslation(RegionTranslation other) {
