...
as List<Asset>,totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _AssetList extends AssetList {
  const _AssetList({required final  List<Asset> items, required this.totalItems}): _items = items,super._();
