...
/// @nodoc
mixin _$FloatCustomFieldConfig {

 List<LocalizedString?>? get description; bool? get internal; List<LocalizedString?>? get label; bool? get list; double? get max; double? get min; String? get name; bool? get nullable; bool? get readonly; List<Permission?>? get requiresPermission; double? get step; String? get type; Map<String, dynamic>? get ui;
/// Create a copy of FloatCustomFieldConfig
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FloatCustomFieldConfigCopyWith<FloatCustomFieldConfig> get copyWith => _$FloatCustomFieldConfigCopyWithImpl<FloatCustomFieldConfig>(this as FloatCustomFieldConfig, _$identity);
...
@override
String toString() {
  return 'FloatCustomFieldConfig(description: $description, internal: $internal, label: $label, list: $list, max: $max, min: $min, name: $name, nullable: $nullable, readonly: $readonly, requiresPermission: $requiresPermission, step: $step, type: $type, ui: $ui)';
}
...
/// @nodoc
abstract mixin class $FloatCustomFieldConfigCopyWith<$Res>  {
...
/// Create a copy of FloatCustomFieldConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? description = freezed,Object? internal = freezed,Object? label = freezed,Object? list = freezed,Object? max = freezed,Object? min = freezed,Object? name = freezed,Object? nullable = freezed,Object? readonly = freezed,Object? requiresPermission = freezed,Object? step = freezed,Object? type = freezed,Object? ui = freezed,}) {
...
/// Adds pattern-matching-related methods to [FloatCustomFieldConfig].
extension FloatCustomFieldConfigPatterns on FloatCustomFieldConfig {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FloatCustomFieldConfig value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FloatCustomFieldConfig() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FloatCustomFieldConfig value)  $default,){
final _that = this;
switch (_that) {
case _FloatCustomFieldConfig():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FloatCustomFieldConfig value)?  $default,){
final _that = this;
switch (_that) {
case _FloatCustomFieldConfig() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<LocalizedString?>? description,  bool? internal,  List<LocalizedString?>? label,  bool? list,  double? max,  double? min,  String? name,  bool? nullable,  bool? readonly,  List<Permission?>? requiresPermission,  double? step,  String? type,  Map<String, dynamic>? ui)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FloatCustomFieldConfig() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<LocalizedString?>? description,  bool? internal,  List<LocalizedString?>? label,  bool? list,  double? max,  double? min,  String? name,  bool? nullable,  bool? readonly,  List<Permission?>? requiresPermission,  double? step,  String? type,  Map<String, dynamic>? ui)  $default,) {final _that = this;
switch (_that) {
case _FloatCustomFieldConfig():
return $default(_that.description,_that.internal,_that.label,_that.list,_that.max,_that.min,_that.name,_that.nullable,_that.readonly,_that.requiresPermission,_that.step,_that.type,_that.ui);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<LocalizedString?>? description,  bool? internal,  List<LocalizedString?>? label,  bool? list,  double? max,  double? min,  String? name,  bool? nullable,  bool? readonly,  List<Permission?>? requiresPermission,  double? step,  String? type,  Map<String, dynamic>? ui)?  $default,) {final _that = this;
switch (_that) {
case _FloatCustomFieldConfig() when $default != null:
return $default(_that.description,_that.internal,_that.label,_that.list,_that.max,_that.min,_that.name,_that.nullable,_that.readonly,_that.requiresPermission,_that.step,_that.type,_that.ui);case _:
  return null;
...
class _FloatCustomFieldConfig extends FloatCustomFieldConfig {
  const _FloatCustomFieldConfig({final  List<LocalizedString?>? description, this.internal, final  List<LocalizedString?>? label, this.list, this.max, this.min, this.name, this.nullable, this.readonly, final  List<Permission?>? requiresPermission, this.step, this.type, final  Map<String, dynamic>? ui}): _description = description,_label = label,_requiresPermission = requiresPermission,_ui = ui,super._();
  factory _FloatCustomFieldConfig.fromJson(Map<String, dynamic> json) => _$FloatCustomFieldConfigFromJson(json);
...
@pragma('vm:prefer-inline')
_$FloatCustomFieldConfigCopyWith<_FloatCustomFieldConfig> get copyWith => __$FloatCustomFieldConfigCopyWithImpl<_FloatCustomFieldConfig>(this, _$identity);
...
/// @nodoc
abstract mixin class _$FloatCustomFieldConfigCopyWith<$Res> implements $FloatCustomFieldConfigCopyWith<$Res> {
  factory _$FloatCustomFieldConfigCopyWith(_FloatCustomFieldConfig value, $Res Function(_FloatCustomFieldConfig) _then) = __$FloatCustomFieldConfigCopyWithImpl;
@override @useResult
$Res call({
 List<LocalizedString?>? description, bool? internal, List<LocalizedString?>? label, bool? list, double? max, double? min, String? name, bool? nullable, bool? readonly, List<Permission?>? requiresPermission, double? step, String? type, Map<String, dynamic>? ui
});
...
/// @nodoc
class __$FloatCustomFieldConfigCopyWithImpl<$Res>
    implements _$FloatCustomFieldConfigCopyWith<$Res> {
  __$FloatCustomFieldConfigCopyWithImpl(this._self, this._then);

  final _FloatCustomFieldConfig _self;
  final $Res Function(_FloatCustomFieldConfig) _then;

/// Create a copy of FloatCustomFieldConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? description = freezed,Object? internal = freezed,Object? label = freezed,Object? list = freezed,Object? max = freezed,Object? min = freezed,Object? name = freezed,Object? nullable = freezed,Object? readonly = freezed,Object? requiresPermission = freezed,Object? step = freezed,Object? type = freezed,Object? ui = freezed,}) {
  return _then(_FloatCustomFieldConfig(
