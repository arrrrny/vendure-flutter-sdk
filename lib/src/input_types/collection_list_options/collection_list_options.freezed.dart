...
/// Allows the results to be filtered
 CollectionFilterParameter? get filter;/// Specifies whether multiple top-level "filter" fields should be combined with a
/// logical AND or OR operation. Defaults to AND.
 ...
 CollectionSortParameter? get sort;/// Takes n results, for use in pagination
 int? get take; bool? get topLevelOnly;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CollectionListOptions&&(identical(other.filter, filter) || other.filter == filter)&&(identical(other.filterOperator, filterOperator) || other.filterOperator == filterOperator)&&(identical(other.skip, skip) || other.skip == skip)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.take, take) || other.take == take)&&(identical(other.topLevelOnly, topLevelOnly) || other.topLevelOnly == topLevelOnly));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,filter,filterOperator,skip,sort,take,topLevelOnly);
...
class _CollectionListOptions extends CollectionListOptions {
  const _CollectionListOptions({this.filter, this.filterOperator, this.skip, this.sort, this.take, this.topLevelOnly}): super._();
  factory _CollectionListOptions.fromJson(Map<String, dynamic> json) => _$CollectionListOptionsFromJson(json);

/// Allows the results to be filtered
@override final  CollectionFilterParameter? filter;
...
@override final  CollectionSortParameter? sort;
/// Takes n results, for use in pagination
@override final  int? take;
@override final  bool? topLevelOnly;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CollectionListOptions&&(identical(other.filter, filter) || other.filter == filter)&&(identical(other.filterOperator, filterOperator) || other.filterOperator == filterOperator)&&(identical(other.skip, skip) || other.skip == skip)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.take, take) || other.take == take)&&(identical(other.topLevelOnly, topLevelOnly) || other.topLevelOnly == topLevelOnly));
}
