...
PaymentFailedError _$PaymentFailedErrorFromJson(Map json) =>
    $checkedCreate('PaymentFailedError', json, ($checkedConvert) {
      final val = PaymentFailedError(
        errorCode: $checkedConvert(
          'errorCode',
          (v) => $enumDecodeNullable(_$ErrorCodeEnumMap, v),
        ),
        message: $checkedConvert('message', (v) => v as String?),
        paymentErrorMessage: $checkedConvert(
          'paymentErrorMessage',
          (v) => v as String?,
        ),
      );
