...
mixin _$SearchResultSortParameter {
 ...
 SortOrder? get name; SortOrder? get price;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchResultSortParameter&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price));
}
...
class _SearchResultSortParameter extends SearchResultSortParameter {
  const _SearchResultSortParameter({this.name, this.price}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SearchResultSortParameter&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price));
}
