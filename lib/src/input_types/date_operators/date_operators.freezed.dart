...
mixin _$DateOperators {
 ...
 DateTime? get after; DateTime? get before; DateRange? get between; DateTime? get eq; bool? get isNull;
...
class _DateOperators extends DateOperators {
  const _DateOperators({this.after, this.before, this.between, this.eq, this.isNull}): super._();
...
@override final  DateRange? between;
@override final  DateTime? eq;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DateOperators&&(identical(other.after, after) || other.after == after)&&(identical(other.before, before) || other.before == before)&&(identical(other.between, between) || other.between == between)&&(identical(other.eq, eq) || other.eq == eq)&&(identical(other.isNull, isNull) || other.isNull == isNull));
}
