...
ProductVariantTranslation _$ProductVariantTranslationFromJson(Map json) =>
    $checkedCreate('ProductVariantTranslation', json, ($checkedConvert) {
      final val = ProductVariantTranslation(
...
Map<String, dynamic> _$ProductVariantTranslationToJson(
  ProductVariantTranslation instance,
) => <String, dynamic>{
