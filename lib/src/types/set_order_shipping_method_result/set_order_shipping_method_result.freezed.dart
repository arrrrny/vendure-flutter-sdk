...
class IneligibleShippingMethodError extends SetOrderShippingMethodResult {
  const IneligibleShippingMethodError({required this.errorCode, required this.message, final  String? $type}): $type = $type ?? 'ineligibleShippingMethodError',super._();
...
class OrderModificationError extends SetOrderShippingMethodResult {
   OrderModificationError({required this.errorCode, required this.message, final  String? $type}): $type = $type ?? 'orderModificationError',super._();
