...
class MissingPasswordError extends VerifyCustomerAccountResult {
  const MissingPasswordError({required this.errorCode, required this.message, final  String? $type}): $type = $type ?? 'missingPasswordError',super._();
...
class PasswordAlreadySetError extends VerifyCustomerAccountResult {
  const PasswordAlreadySetError({required this.errorCode, required this.message, final  String? $type}): $type = $type ?? 'passwordAlreadySetError',super._();
...
class VerificationTokenExpiredError extends VerifyCustomerAccountResult {
  const VerificationTokenExpiredError({required this.errorCode, required this.message, final  String? $type}): $type = $type ?? 'verificationTokenExpiredError',super._();
...
class VerificationTokenInvalidError extends VerifyCustomerAccountResult {
  const VerificationTokenInvalidError({required this.errorCode, required this.message, final  String? $type}): $type = $type ?? 'verificationTokenInvalidError',super._();
