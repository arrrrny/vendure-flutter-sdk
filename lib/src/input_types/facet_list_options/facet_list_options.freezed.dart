...
/// Allows the results to be filtered
 FacetFilterParameter? get filter;/// Specifies whether multiple top-level "filter" fields should be combined with a
/// logical AND or OR operation. Defaults to AND.
 ...
 FacetSortParameter? get sort;/// Takes n results, for use in pagination
 int? get take;
...
class _FacetListOptions extends FacetListOptions {
  const _FacetListOptions({this.filter, this.filterOperator, this.skip, this.sort, this.take}): super._();
  factory _FacetListOptions.fromJson(Map<String, dynamic> json) => _$FacetListOptionsFromJson(json);

/// Allows the results to be filtered
@override final  FacetFilterParameter? filter;
...
@override final  FacetSortParameter? sort;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FacetListOptions&&(identical(other.filter, filter) || other.filter == filter)&&(identical(other.filterOperator, filterOperator) || other.filterOperator == filterOperator)&&(identical(other.skip, skip) || other.skip == skip)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.take, take) || other.take == take));
}
