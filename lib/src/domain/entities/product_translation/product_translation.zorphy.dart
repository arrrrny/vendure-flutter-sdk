...
class ProductTranslation {
  ...
  ProductTranslation copyWithProductTranslation({
    DateTime? createdAt,
    String? description,
    String? id,
    LanguageCode? languageCode,
  ...
  ProductTranslation patchWithProductTranslation([
    ProductTranslationPatch? patchInput,
  ]) {
    final _patcher = patchInput ?? ProductTranslationPatch();
    final _patchMap = _patcher.patchMap;
    return ProductTranslation(
      createdAt: _patchMap.containsKey(ProductTranslation$.createdAt)
          ? (_patchMap[ProductTranslation$.createdAt] is Function)
                ? _patchMap[ProductTranslation$.createdAt](this.createdAt)
                : (_patchMap[ProductTranslation$.createdAt] is Patch)
                ? _patchMap[ProductTranslation$.createdAt].applyTo(
                    this.createdAt,
                  )
                : _patchMap[ProductTranslation$.createdAt]
          : this.createdAt,
      description: _patchMap.containsKey(ProductTranslation$.description)
          ? (_patchMap[ProductTranslation$.description] is Function)
                ? _patchMap[ProductTranslation$.description](this.description)
                : (_patchMap[ProductTranslation$.description] is Patch)
                ? _patchMap[ProductTranslation$.description].applyTo(
                    this.description,
                  )
                : _patchMap[ProductTranslation$.description]
          : this.description,
      id: _patchMap.containsKey(ProductTranslation$.id)
          ? (_patchMap[ProductTranslation$.id] is Function)
                ? _patchMap[ProductTranslation$.id](this.id)
                : (_patchMap[ProductTranslation$.id] is Patch)
                ? _patchMap[ProductTranslation$.id].applyTo(this.id)
                : _patchMap[ProductTranslation$.id]
          : this.id,
      languageCode: _patchMap.containsKey(ProductTranslation$.languageCode)
          ? (_patchMap[ProductTranslation$.languageCode] is Function)
                ? _patchMap[ProductTranslation$.languageCode](this.languageCode)
                : (_patchMap[ProductTranslation$.languageCode] is Patch)
                ? _patchMap[ProductTranslation$.languageCode].applyTo(
                    this.languageCode,
                  )
                : _patchMap[ProductTranslation$.languageCode]
          : this.languageCode,
      name: _patchMap.containsKey(ProductTranslation$.name_)
          ? (_patchMap[ProductTranslation$.name_] is Function)
                ? _patchMap[ProductTranslation$.name_](this.name)
                : (_patchMap[ProductTranslation$.name_] is Patch)
                ? _patchMap[ProductTranslation$.name_].applyTo(this.name)
                : _patchMap[ProductTranslation$.name_]
          : this.name,
      slug: _patchMap.containsKey(ProductTranslation$.slug)
          ? (_patchMap[ProductTranslation$.slug] is Function)
                ? _patchMap[ProductTranslation$.slug](this.slug)
                : (_patchMap[ProductTranslation$.slug] is Patch)
                ? _patchMap[ProductTranslation$.slug].applyTo(this.slug)
                : _patchMap[ProductTranslation$.slug]
          : this.slug,
      updatedAt: _patchMap.containsKey(ProductTranslation$.updatedAt)
          ? (_patchMap[ProductTranslation$.updatedAt] is Function)
                ? _patchMap[ProductTranslation$.updatedAt](this.updatedAt)
                : (_patchMap[ProductTranslation$.updatedAt] is Patch)
                ? _patchMap[ProductTranslation$.updatedAt].applyTo(
                    this.updatedAt,
                  )
                : _patchMap[ProductTranslation$.updatedAt]
          : this.updatedAt,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ProductTranslation &&
  ...
  Map<String, dynamic> toJsonLean() {
    final Map<String, dynamic> data = _$ProductTranslationToJson(this);
...
extension ProductTranslationPropertyHelpers on ProductTranslation {
...
extension ProductTranslationSerialization on ProductTranslation {
  Map<String, dynamic> toJson() {
    return _$ProductTranslationToJson(this);
  }
}
...
class ProductTranslationPatch
    extends PatchBase<ProductTranslation, ProductTranslation$> {
  ProductTranslation applyTo(ProductTranslation entity) {
    return entity.patchWithProductTranslation(this);
  }

  ProductTranslationPatch withCreatedAt(DateTime? value) {
    patchMap[ProductTranslation$.createdAt] = value;
    return this;
  }

  ProductTranslationPatch withDescription(String? value) {
    patchMap[ProductTranslation$.description] = value;
    return this;
  }

  ProductTranslationPatch withId(String? value) {
    patchMap[ProductTranslation$.id] = value;
    return this;
  }

  ProductTranslationPatch withLanguageCode(LanguageCode? value) {
    patchMap[ProductTranslation$.languageCode] = value;
    return this;
  }

  ProductTranslationPatch withName(String? value) {
    patchMap[ProductTranslation$.name_] = value;
    return this;
  }

  ProductTranslationPatch withSlug(String? value) {
    patchMap[ProductTranslation$.slug] = value;
    return this;
  }

  ProductTranslationPatch withUpdatedAt(DateTime? value) {
    patchMap[ProductTranslation$.updatedAt] = value;
    return this;
  }
}

/// Field descriptors for [ProductTranslation] query construction
abstract final class ProductTranslationFields {
  static const createdAt = Field<ProductTranslation, DateTime?>(
    'createdAt',
    _$createdAt,
  );

  static const description = Field<ProductTranslation, String?>(
    'description',
    _$description,
  );

  static const id = Field<ProductTranslation, String?>('id', _$id);

  static const languageCode = Field<ProductTranslation, LanguageCode?>(
    'languageCode',
    _$languageCode,
  );

  static const name = Field<ProductTranslation, String?>('name', _$name);

  static const slug = Field<ProductTranslation, String?>('slug', _$slug);

  static const updatedAt = Field<ProductTranslation, DateTime?>(
    'updatedAt',
    _$updatedAt,
  );

  static DateTime? _$createdAt(ProductTranslation e) {
    return e.createdAt;
  }

  static String? _$description(ProductTranslation e) {
    return e.description;
  }

  static String? _$id(ProductTranslation e) {
    return e.id;
  }

  static LanguageCode? _$languageCode(ProductTranslation e) {
    return e.languageCode;
  }

  static String? _$name(ProductTranslation e) {
    return e.name;
  }

  static String? _$slug(ProductTranslation e) {
    return e.slug;
  }

  static DateTime? _$updatedAt(ProductTranslation e) {
    return e.updatedAt;
  }
}

extension ProductTranslationCompareE on ProductTranslation {
  Map<String, dynamic> compareToProductTranslation(ProductTranslation other) {
