...
/// Create a copy of StringFieldOption
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? label = freezed,Object? value = null,}) {
  return _then(_self.copyWith(
label: freezed == label ? _self.label : label // ignore: cast_nullable_to_non_nullable
as List<LocalizedString>?,value: null == value ? _self.value : value // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class _StringFieldOption extends StringFieldOption {
  const _StringFieldOption({final  List<LocalizedString>? label, required this.value}): _label = label,super._();
...
/// Create a copy of StringFieldOption
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? label = freezed,Object? value = null,}) {
