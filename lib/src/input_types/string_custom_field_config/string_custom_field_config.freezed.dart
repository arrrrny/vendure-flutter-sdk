...
class _StringCustomFieldConfig extends StringCustomFieldConfig {
  const _StringCustomFieldConfig({final  List<LocalizedString?>? description, this.internal, final  List<LocalizedString?>? label, this.length, this.list, this.name, this.nullable, final  List<StringFieldOption?>? options, this.pattern, this.readonly, final  List<Permission?>? requiresPermission, this.type, final  Map<String, dynamic>? ui}): _description = description,_label = label,_options = options,_requiresPermission = requiresPermission,_ui = ui,super._();
