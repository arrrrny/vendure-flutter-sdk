...
/// data generated by the payment provider.
 Map<String, dynamic> get metadata;/// This field should correspond to the `code` property of a PaymentMethod.
 String get method;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PaymentInput&&const DeepCollectionEquality().equals(other.metadata, metadata)&&(identical(other.method, method) || other.method == method));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(metadata),method);
...
class _PaymentInput extends PaymentInput {
  const _PaymentInput({required final  Map<String, dynamic> metadata, required this.method}): _metadata = metadata,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PaymentInput&&const DeepCollectionEquality().equals(other._metadata, _metadata)&&(identical(other.method, method) || other.method == method));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_metadata),method);
