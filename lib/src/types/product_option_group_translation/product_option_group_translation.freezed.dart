...
class _ProductOptionGroupTranslation extends ProductOptionGroupTranslation {
  const _ProductOptionGroupTranslation({required this.createdAt, required this.id, required this.languageCode, required this.name, required this.updatedAt}): super._();
