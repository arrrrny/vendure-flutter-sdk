...
mixin _$ProductSortParameter {
 ...
 SortOrder? get createdAt; set createdAt(SortOrder? value); SortOrder? get description; set description(SortOrder? value); SortOrder? get id; set id(SortOrder? value); SortOrder? get name; set name(SortOrder? value); SortOrder? get slug; set slug(SortOrder? value); SortOrder? get updatedAt; set updatedAt(SortOrder? value);
...
class _ProductSortParameter extends ProductSortParameter {
   _ProductSortParameter({this.createdAt, this.description, this.id, this.name, this.slug, this.updatedAt}): super._();
