...
PromotionTranslation _$PromotionTranslationFromJson(Map json) =>
    $checkedCreate('PromotionTranslation', json, ($checkedConvert) {
      final val = PromotionTranslation(
