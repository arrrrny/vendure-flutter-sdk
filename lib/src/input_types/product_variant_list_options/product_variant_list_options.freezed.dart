...
/// Allows the results to be filtered
 ProductVariantFilterParameter? get filter;/// Specifies whether multiple top-level "filter" fields should be combined with a
/// logical AND or OR operation. Defaults to AND.
 ...
 ProductVariantSortParameter? get sort;/// Takes n results, for use in pagination
 int? get take;
...
class _ProductVariantListOptions extends ProductVariantListOptions {
  const _ProductVariantListOptions({this.filter, this.filterOperator, this.skip, this.sort, this.take}): super._();
  factory _ProductVariantListOptions.fromJson(Map<String, dynamic> json) => _$ProductVariantListOptionsFromJson(json);

/// Allows the results to be filtered
@override final  ProductVariantFilterParameter? filter;
...
@override final  ProductVariantSortParameter? sort;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductVariantListOptions&&(identical(other.filter, filter) || other.filter == filter)&&(identical(other.filterOperator, filterOperator) || other.filterOperator == filterOperator)&&(identical(other.skip, skip) || other.skip == skip)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.take, take) || other.take == take));
}
