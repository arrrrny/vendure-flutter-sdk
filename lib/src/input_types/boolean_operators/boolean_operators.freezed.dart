...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BooleanOperators&&(identical(other.eq, eq) || other.eq == eq)&&(identical(other.isNull, isNull) || other.isNull == isNull));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BooleanOperators&&(identical(other.eq, eq) || other.eq == eq)&&(identical(other.isNull, isNull) || other.isNull == isNull));
}
