...
class _$CreateAddressInputImpl extends _CreateAddressInput
  ...
  const _$CreateAddressInputImpl(
      {this.city,
      this.company,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateAddressInputImpl &&
...
abstract class _CreateAddressInput extends CreateAddressInput {
  const factory _CreateAddressInput(
      {final String? city,
      final String? company,
      ...
      final String? streetLine2}) = _$CreateAddressInputImpl;
  const _CreateAddressInput._() : super._();
