...
mixin _$ProductVariantSortParameter {
 ...
 SortOrder? get createdAt; SortOrder? get id; SortOrder? get name; SortOrder? get price; SortOrder? get priceWithTax; SortOrder? get productId; SortOrder? get sku; SortOrder? get stockLevel; SortOrder? get updatedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductVariantSortParameter&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price)&&(identical(other.priceWithTax, priceWithTax) || other.priceWithTax == priceWithTax)&&(identical(other.productId, productId) || other.productId == productId)&&(identical(other.sku, sku) || other.sku == sku)&&(identical(other.stockLevel, stockLevel) || other.stockLevel == stockLevel)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,createdAt,id,name,price,priceWithTax,productId,sku,stockLevel,updatedAt);
...
class _ProductVariantSortParameter extends ProductVariantSortParameter {
  const _ProductVariantSortParameter({this.createdAt, this.id, this.name, this.price, this.priceWithTax, this.productId, this.sku, this.stockLevel, this.updatedAt}): super._();
...
@override final  SortOrder? price;
@override final  SortOrder? priceWithTax;
@override final  SortOrder? productId;
@override final  SortOrder? sku;
@override final  SortOrder? stockLevel;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductVariantSortParameter&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price)&&(identical(other.priceWithTax, priceWithTax) || other.priceWithTax == priceWithTax)&&(identical(other.productId, productId) || other.productId == productId)&&(identical(other.sku, sku) || other.sku == sku)&&(identical(other.stockLevel, stockLevel) || other.stockLevel == stockLevel)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}
