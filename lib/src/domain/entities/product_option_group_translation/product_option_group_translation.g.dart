...
ProductOptionGroupTranslation _$ProductOptionGroupTranslationFromJson(
  Map json,
) => $checkedCreate('ProductOptionGroupTranslation', json, ($checkedConvert) {
  final val = ProductOptionGroupTranslation(
...
Map<String, dynamic> _$ProductOptionGroupTranslationToJson(
  ProductOptionGroupTranslation instance,
) => <String, dynamic>{
