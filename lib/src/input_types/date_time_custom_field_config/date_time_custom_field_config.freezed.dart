...
DateTimeCustomFieldConfig _$DateTimeCustomFieldConfigFromJson(
    Map<String, dynamic> json) {
  return _DateTimeCustomFieldConfig.fromJson(json);
}
...
/// @nodoc
abstract class $DateTimeCustomFieldConfigCopyWith<$Res> {
  factory $DateTimeCustomFieldConfigCopyWith(DateTimeCustomFieldConfig value,
          $Res Function(DateTimeCustomFieldConfig) then) =
...
class _$DateTimeCustomFieldConfigCopyWithImpl<$Res,
        $Val extends DateTimeCustomFieldConfig>
    implements $DateTimeCustomFieldConfigCopyWith<$Res> {
  _$DateTimeCustomFieldConfigCopyWithImpl(this._value, this._then);
...
class __$$DateTimeCustomFieldConfigImplCopyWithImpl<$Res>
    extends _$DateTimeCustomFieldConfigCopyWithImpl<$Res,
...
abstract class _DateTimeCustomFieldConfig extends DateTimeCustomFieldConfig {
  ...
  factory _DateTimeCustomFieldConfig.fromJson(Map<String, dynamic> json) =
