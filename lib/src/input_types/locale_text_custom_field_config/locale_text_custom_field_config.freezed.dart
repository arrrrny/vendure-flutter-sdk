...
LocaleTextCustomFieldConfig _$LocaleTextCustomFieldConfigFromJson(
    Map<String, dynamic> json) {
  return _LocaleTextCustomFieldConfig.fromJson(json);
}
...
mixin _$LocaleTextCustomFieldConfig {
  ...
  $LocaleTextCustomFieldConfigCopyWith<LocaleTextCustomFieldConfig>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LocaleTextCustomFieldConfigCopyWith<$Res> {
  factory $LocaleTextCustomFieldConfigCopyWith(
          LocaleTextCustomFieldConfig value,
          $Res Function(LocaleTextCustomFieldConfig) then) =
      _$LocaleTextCustomFieldConfigCopyWithImpl<$Res,
...
class _$LocaleTextCustomFieldConfigCopyWithImpl<$Res,
        $Val extends LocaleTextCustomFieldConfig>
    implements $LocaleTextCustomFieldConfigCopyWith<$Res> {
  _$LocaleTextCustomFieldConfigCopyWithImpl(this._value, this._then);
...
class __$$LocaleTextCustomFieldConfigImplCopyWithImpl<$Res>
    extends _$LocaleTextCustomFieldConfigCopyWithImpl<$Res,
...
/// @nodoc
@JsonSerializable()
class _$LocaleTextCustomFieldConfigImpl extends _LocaleTextCustomFieldConfig
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'LocaleTextCustomFieldConfig'))
...
abstract class _LocaleTextCustomFieldConfig
    extends LocaleTextCustomFieldConfig {
  const factory _LocaleTextCustomFieldConfig(
      {final List<LocalizedString?>? description,
      final bool? internal,
      final List<LocalizedString?>? label,
      final bool? list,
  ...
  const _LocaleTextCustomFieldConfig._() : super._();

  factory _LocaleTextCustomFieldConfig.fromJson(Map<String, dynamic> json) =
