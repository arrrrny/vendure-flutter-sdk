...
mixin _$NumberRange {
 ...
 double get end; double get start;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NumberRange&&(identical(other.end, end) || other.end == end)&&(identical(other.start, start) || other.start == start));
}
...
class _NumberRange extends NumberRange {
  const _NumberRange({required this.end, required this.start}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NumberRange&&(identical(other.end, end) || other.end == end)&&(identical(other.start, start) || other.start == start));
}
