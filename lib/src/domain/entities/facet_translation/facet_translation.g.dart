...
FacetTranslation _$FacetTranslationFromJson(Map json) =>
    $checkedCreate('FacetTranslation', json, ($checkedConvert) {
      final val = FacetTranslation(
...
Map<String, dynamic> _$FacetTranslationToJson(FacetTranslation instance) =>
    <String, dynamic>{
