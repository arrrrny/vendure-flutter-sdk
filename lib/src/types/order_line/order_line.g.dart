...
_OrderLine _$OrderLineFromJson(Map json) => _OrderLine(
  ...
  fulfillmentLines: (json['fulfillmentLines'] as List<dynamic>?)
      ?.map(
        (e) => FulfillmentLine.fromJson(Map<String, dynamic>.from(e as Map)),
      )
      .toList(),
...
Map<String, dynamic> _$OrderLineToJson(
  _OrderLine instance,
) => <String, dynamic>{
  ...
  'unitPriceWithTaxChangeSinceAdded': instance.unitPriceWithTaxChangeSinceAdded,
