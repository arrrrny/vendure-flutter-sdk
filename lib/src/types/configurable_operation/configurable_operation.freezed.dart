...
/// Create a copy of ConfigurableOperation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? args = null,Object? code = null,}) {
  return _then(_self.copyWith(
args: null == args ? _self.args : args // ignore: cast_nullable_to_non_nullable
as List<ConfigArg>,code: null == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class _ConfigurableOperation extends ConfigurableOperation {
  const _ConfigurableOperation({required final  List<ConfigArg> args, required this.code}): _args = args,super._();
...
/// Create a copy of ConfigurableOperation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? args = null,Object? code = null,}) {
