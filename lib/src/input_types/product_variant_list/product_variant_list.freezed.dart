...
as List<ProductVariant?>?,totalItems: freezed == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
class _ProductVariantList extends ProductVariantList {
  const _ProductVariantList({final  List<ProductVariant?>? items, this.totalItems}): _items = items,super._();
