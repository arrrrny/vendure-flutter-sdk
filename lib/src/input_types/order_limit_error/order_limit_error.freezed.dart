...
/// Create a copy of OrderLimitError
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? errorCode = freezed,Object? maxItems = freezed,Object? message = freezed,}) {
...
class _OrderLimitError extends OrderLimitError {
  const _OrderLimitError({this.errorCode, this.maxItems, this.message}): super._();
...
/// Create a copy of OrderLimitError
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? errorCode = freezed,Object? maxItems = freezed,Object? message = freezed,}) {
