...
as List<Facet?>?,totalItems: freezed == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
class _FacetList extends FacetList {
  const _FacetList({final  List<Facet?>? items, this.totalItems}): _items = items,super._();
