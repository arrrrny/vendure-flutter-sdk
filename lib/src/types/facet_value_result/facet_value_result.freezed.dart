...
/// Create a copy of FacetValueResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? count = null,Object? facetValue = null,}) {
  return _then(_self.copyWith(
count: null == count ? _self.count : count // ignore: cast_nullable_to_non_nullable
as int,facetValue: null == facetValue ? _self.facetValue : facetValue // ignore: cast_nullable_to_non_nullable
as FacetValue,
  ));
}
/// Create a copy of FacetValueResult
...
class _FacetValueResult extends FacetValueResult {
  const _FacetValueResult({required this.count, required this.facetValue}): super._();
...
/// Create a copy of FacetValueResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? count = null,Object? facetValue = null,}) {
