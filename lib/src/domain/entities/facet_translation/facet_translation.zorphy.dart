...
class FacetTranslation {
  ...
  FacetTranslation copyWithFacetTranslation({
    DateTime? createdAt,
    String? id,
    LanguageCode? languageCode,
    String? name,
  ...
  FacetTranslation patchWithFacetTranslation([
    FacetTranslationPatch? patchInput,
  ]) {
    final _patcher = patchInput ?? FacetTranslationPatch();
    final _patchMap = _patcher.patchMap;
    return FacetTranslation(
      createdAt: _patchMap.containsKey(FacetTranslation$.createdAt)
          ? (_patchMap[FacetTranslation$.createdAt] is Function)
                ? _patchMap[FacetTranslation$.createdAt](this.createdAt)
                : (_patchMap[FacetTranslation$.createdAt] is Patch)
                ? _patchMap[FacetTranslation$.createdAt].applyTo(this.createdAt)
                : _patchMap[FacetTranslation$.createdAt]
          : this.createdAt,
      id: _patchMap.containsKey(FacetTranslation$.id)
          ? (_patchMap[FacetTranslation$.id] is Function)
                ? _patchMap[FacetTranslation$.id](this.id)
                : (_patchMap[FacetTranslation$.id] is Patch)
                ? _patchMap[FacetTranslation$.id].applyTo(this.id)
                : _patchMap[FacetTranslation$.id]
          : this.id,
      languageCode: _patchMap.containsKey(FacetTranslation$.languageCode)
          ? (_patchMap[FacetTranslation$.languageCode] is Function)
                ? _patchMap[FacetTranslation$.languageCode](this.languageCode)
                : (_patchMap[FacetTranslation$.languageCode] is Patch)
                ? _patchMap[FacetTranslation$.languageCode].applyTo(
                    this.languageCode,
                  )
                : _patchMap[FacetTranslation$.languageCode]
          : this.languageCode,
      name: _patchMap.containsKey(FacetTranslation$.name_)
          ? (_patchMap[FacetTranslation$.name_] is Function)
                ? _patchMap[FacetTranslation$.name_](this.name)
                : (_patchMap[FacetTranslation$.name_] is Patch)
                ? _patchMap[FacetTranslation$.name_].applyTo(this.name)
                : _patchMap[FacetTranslation$.name_]
          : this.name,
      updatedAt: _patchMap.containsKey(FacetTranslation$.updatedAt)
          ? (_patchMap[FacetTranslation$.updatedAt] is Function)
                ? _patchMap[FacetTranslation$.updatedAt](this.updatedAt)
                : (_patchMap[FacetTranslation$.updatedAt] is Patch)
                ? _patchMap[FacetTranslation$.updatedAt].applyTo(this.updatedAt)
                : _patchMap[FacetTranslation$.updatedAt]
          : this.updatedAt,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is FacetTranslation &&
  ...
  Map<String, dynamic> toJsonLean() {
    final Map<String, dynamic> data = _$FacetTranslationToJson(this);
...
extension FacetTranslationPropertyHelpers on FacetTranslation {
...
extension FacetTranslationSerialization on FacetTranslation {
  Map<String, dynamic> toJson() {
    return _$FacetTranslationToJson(this);
  }
}

enum FacetTranslation$ { createdAt, id, languageCode, name_, updatedAt }

class FacetTranslationPatch
    extends PatchBase<FacetTranslation, FacetTranslation$> {
  FacetTranslation applyTo(FacetTranslation entity) {
    return entity.patchWithFacetTranslation(this);
  }

  FacetTranslationPatch withCreatedAt(DateTime? value) {
    patchMap[FacetTranslation$.createdAt] = value;
    return this;
  }

  FacetTranslationPatch withId(String? value) {
    patchMap[FacetTranslation$.id] = value;
    return this;
  }

  FacetTranslationPatch withLanguageCode(LanguageCode? value) {
    patchMap[FacetTranslation$.languageCode] = value;
    return this;
  }

  FacetTranslationPatch withName(String? value) {
    patchMap[FacetTranslation$.name_] = value;
    return this;
  }

  FacetTranslationPatch withUpdatedAt(DateTime? value) {
    patchMap[FacetTranslation$.updatedAt] = value;
    return this;
  }
}

/// Field descriptors for [FacetTranslation] query construction
abstract final class FacetTranslationFields {
  static const createdAt = Field<FacetTranslation, DateTime?>(
    'createdAt',
    _$createdAt,
  );

  static const id = Field<FacetTranslation, String?>('id', _$id);

  static const languageCode = Field<FacetTranslation, LanguageCode?>(
    'languageCode',
    _$languageCode,
  );

  static const name = Field<FacetTranslation, String?>('name', _$name);

  static const updatedAt = Field<FacetTranslation, DateTime?>(
    'updatedAt',
    _$updatedAt,
  );

  static DateTime? _$createdAt(FacetTranslation e) {
    return e.createdAt;
  }

  static String? _$id(FacetTranslation e) {
    return e.id;
  }

  static LanguageCode? _$languageCode(FacetTranslation e) {
    return e.languageCode;
  }

  static String? _$name(FacetTranslation e) {
    return e.name;
  }

  static DateTime? _$updatedAt(FacetTranslation e) {
    return e.updatedAt;
  }
}

extension FacetTranslationCompareE on FacetTranslation {
  Map<String, dynamic> compareToFacetTranslation(FacetTranslation other) {
