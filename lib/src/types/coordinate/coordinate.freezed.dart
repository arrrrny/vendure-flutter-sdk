...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Coordinate&&(identical(other.x, x) || other.x == x)&&(identical(other.y, y) || other.y == y));
}
...
class _Coordinate extends Coordinate {
  const _Coordinate({required this.x, required this.y}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Coordinate&&(identical(other.x, x) || other.x == x)&&(identical(other.y, y) || other.y == y));
}
