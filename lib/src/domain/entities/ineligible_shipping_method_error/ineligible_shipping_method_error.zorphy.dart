...
class IneligibleShippingMethodError {
  ...
  IneligibleShippingMethodError copyWith({
    ErrorCode? errorCode,
    String? message,
  }) {
  ...
  IneligibleShippingMethodError copyWithIneligibleShippingMethodError({
    ErrorCode? errorCode,
    String? message,
  }) {
  ...
  IneligibleShippingMethodError patchWithIneligibleShippingMethodError([
    IneligibleShippingMethodErrorPatch? patchInput,
  ]) {
    final _patcher = patchInput ?? IneligibleShippingMethodErrorPatch();
    final _patchMap = _patcher.patchMap;
    return IneligibleShippingMethodError(
      errorCode: _patchMap.containsKey(IneligibleShippingMethodError$.errorCode)
          ? (_patchMap[IneligibleShippingMethodError$.errorCode] is Function)
                ? _patchMap[IneligibleShippingMethodError$.errorCode](
                    this.errorCode,
                  )
                : (_patchMap[IneligibleShippingMethodError$.errorCode] is Patch)
                ? _patchMap[IneligibleShippingMethodError$.errorCode].applyTo(
                    this.errorCode,
                  )
                : _patchMap[IneligibleShippingMethodError$.errorCode]
          : this.errorCode,
      message: _patchMap.containsKey(IneligibleShippingMethodError$.message)
          ? (_patchMap[IneligibleShippingMethodError$.message] is Function)
                ? _patchMap[IneligibleShippingMethodError$.message](
                    this.message,
                  )
                : (_patchMap[IneligibleShippingMethodError$.message] is Patch)
                ? _patchMap[IneligibleShippingMethodError$.message].applyTo(
                    this.message,
                  )
                : _patchMap[IneligibleShippingMethodError$.message]
          : this.message,
  ...
  bool operator ==(Object other) {
    ...
    return other is IneligibleShippingMethodError &&
  ...
  Map<String, dynamic> toJsonLean() {
    final Map<String, dynamic> data = _$IneligibleShippingMethodErrorToJson(
      this,
    );
...
extension IneligibleShippingMethodErrorPropertyHelpers
...
extension IneligibleShippingMethodErrorSerialization
    on IneligibleShippingMethodError {
...
enum IneligibleShippingMethodError$ { errorCode, message }

class IneligibleShippingMethodErrorPatch
    extends
        PatchBase<
          IneligibleShippingMethodError,
          IneligibleShippingMethodError$
        > {
  IneligibleShippingMethodError applyTo(IneligibleShippingMethodError entity) {
    return entity.patchWithIneligibleShippingMethodError(this);
  }

  IneligibleShippingMethodErrorPatch withErrorCode(ErrorCode? value) {
    patchMap[IneligibleShippingMethodError$.errorCode] = value;
    return this;
  }

  IneligibleShippingMethodErrorPatch withMessage(String? value) {
    patchMap[IneligibleShippingMethodError$.message] = value;
    return this;
  }
}

/// Field descriptors for [IneligibleShippingMethodError] query construction
abstract final class IneligibleShippingMethodErrorFields {
  static const errorCode = Field<IneligibleShippingMethodError, ErrorCode?>(
    'errorCode',
    _$errorCode,
  );

  static const message = Field<IneligibleShippingMethodError, String?>(
    'message',
    _$message,
  );

  static ErrorCode? _$errorCode(IneligibleShippingMethodError e) {
    return e.errorCode;
  }

  static String? _$message(IneligibleShippingMethodError e) {
    return e.message;
  }
}

extension IneligibleShippingMethodErrorCompareE
    on IneligibleShippingMethodError {
  Map<String, dynamic> compareToIneligibleShippingMethodError(
    IneligibleShippingMethodError other,
  ) {
