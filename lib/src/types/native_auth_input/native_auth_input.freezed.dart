...
mixin _$NativeAuthInput {
 ...
 String get password; set password(String value); String get username; set username(String value);
...
class _NativeAuthInput extends NativeAuthInput {
   _NativeAuthInput({required this.password, required this.username}): super._();
