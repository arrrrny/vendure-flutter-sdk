...
class IdentifierChangeTokenExpiredError extends UpdateCustomerEmailAddressResult {
  const IdentifierChangeTokenExpiredError({this.errorCode, this.message, final  String? $type}): $type = $type ?? 'identifierChangeTokenExpiredError',super._();
...
class IdentifierChangeTokenInvalidError extends UpdateCustomerEmailAddressResult {
  const IdentifierChangeTokenInvalidError({this.errorCode, this.message, final  String? $type}): $type = $type ?? 'identifierChangeTokenInvalidError',super._();
