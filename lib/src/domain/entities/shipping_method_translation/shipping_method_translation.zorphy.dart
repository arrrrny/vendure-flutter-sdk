...
class ShippingMethodTranslation {
  ...
  ShippingMethodTranslation copyWith({
    DateTime? createdAt,
    String? description,
    String? id,
  ...
  ShippingMethodTranslation copyWithShippingMethodTranslation({
    DateTime? createdAt,
    String? description,
    String? id,
    LanguageCode? languageCode,
  ...
  ShippingMethodTranslation patchWithShippingMethodTranslation([
    ShippingMethodTranslationPatch? patchInput,
  ]) {
    final _patcher = patchInput ?? ShippingMethodTranslationPatch();
    final _patchMap = _patcher.patchMap;
    return ShippingMethodTranslation(
      createdAt: _patchMap.containsKey(ShippingMethodTranslation$.createdAt)
          ? (_patchMap[ShippingMethodTranslation$.createdAt] is Function)
                ? _patchMap[ShippingMethodTranslation$.createdAt](
                    this.createdAt,
                  )
                : (_patchMap[ShippingMethodTranslation$.createdAt] is Patch)
                ? _patchMap[ShippingMethodTranslation$.createdAt].applyTo(
                    this.createdAt,
                  )
                : _patchMap[ShippingMethodTranslation$.createdAt]
          : this.createdAt,
      description: _patchMap.containsKey(ShippingMethodTranslation$.description)
          ? (_patchMap[ShippingMethodTranslation$.description] is Function)
                ? _patchMap[ShippingMethodTranslation$.description](
                    this.description,
                  )
                : (_patchMap[ShippingMethodTranslation$.description] is Patch)
                ? _patchMap[ShippingMethodTranslation$.description].applyTo(
                    this.description,
                  )
                : _patchMap[ShippingMethodTranslation$.description]
          : this.description,
      id: _patchMap.containsKey(ShippingMethodTranslation$.id)
          ? (_patchMap[ShippingMethodTranslation$.id] is Function)
                ? _patchMap[ShippingMethodTranslation$.id](this.id)
                : (_patchMap[ShippingMethodTranslation$.id] is Patch)
                ? _patchMap[ShippingMethodTranslation$.id].applyTo(this.id)
                : _patchMap[ShippingMethodTranslation$.id]
          : this.id,
      languageCode:
          _patchMap.containsKey(ShippingMethodTranslation$.languageCode)
          ? (_patchMap[ShippingMethodTranslation$.languageCode] is Function)
                ? _patchMap[ShippingMethodTranslation$.languageCode](
                    this.languageCode,
                  )
                : (_patchMap[ShippingMethodTranslation$.languageCode] is Patch)
                ? _patchMap[ShippingMethodTranslation$.languageCode].applyTo(
                    this.languageCode,
                  )
                : _patchMap[ShippingMethodTranslation$.languageCode]
          : this.languageCode,
      name: _patchMap.containsKey(ShippingMethodTranslation$.name_)
          ? (_patchMap[ShippingMethodTranslation$.name_] is Function)
                ? _patchMap[ShippingMethodTranslation$.name_](this.name)
                : (_patchMap[ShippingMethodTranslation$.name_] is Patch)
                ? _patchMap[ShippingMethodTranslation$.name_].applyTo(this.name)
                : _patchMap[ShippingMethodTranslation$.name_]
          : this.name,
      updatedAt: _patchMap.containsKey(ShippingMethodTranslation$.updatedAt)
          ? (_patchMap[ShippingMethodTranslation$.updatedAt] is Function)
                ? _patchMap[ShippingMethodTranslation$.updatedAt](
                    this.updatedAt,
                  )
                : (_patchMap[ShippingMethodTranslation$.updatedAt] is Patch)
                ? _patchMap[ShippingMethodTranslation$.updatedAt].applyTo(
                    this.updatedAt,
                  )
                : _patchMap[ShippingMethodTranslation$.updatedAt]
          : this.updatedAt,
  ...
  bool operator ==(Object other) {
    ...
    return other is ShippingMethodTranslation &&
  ...
  Map<String, dynamic> toJsonLean() {
    final Map<String, dynamic> data = _$ShippingMethodTranslationToJson(this);
...
extension ShippingMethodTranslationPropertyHelpers
...
extension ShippingMethodTranslationSerialization on ShippingMethodTranslation {
  Map<String, dynamic> toJson() {
    return _$ShippingMethodTranslationToJson(this);
  }
}

enum ShippingMethodTranslation$ {
  createdAt,
  description,
  id,
  languageCode,
...
class ShippingMethodTranslationPatch
    extends PatchBase<ShippingMethodTranslation, ShippingMethodTranslation$> {
  ShippingMethodTranslation applyTo(ShippingMethodTranslation entity) {
    return entity.patchWithShippingMethodTranslation(this);
  }

  ShippingMethodTranslationPatch withCreatedAt(DateTime? value) {
    patchMap[ShippingMethodTranslation$.createdAt] = value;
    return this;
  }

  ShippingMethodTranslationPatch withDescription(String? value) {
    patchMap[ShippingMethodTranslation$.description] = value;
    return this;
  }

  ShippingMethodTranslationPatch withId(String? value) {
    patchMap[ShippingMethodTranslation$.id] = value;
    return this;
  }

  ShippingMethodTranslationPatch withLanguageCode(LanguageCode? value) {
    patchMap[ShippingMethodTranslation$.languageCode] = value;
    return this;
  }

  ShippingMethodTranslationPatch withName(String? value) {
    patchMap[ShippingMethodTranslation$.name_] = value;
    return this;
  }

  ShippingMethodTranslationPatch withUpdatedAt(DateTime? value) {
    patchMap[ShippingMethodTranslation$.updatedAt] = value;
    return this;
  }
}

/// Field descriptors for [ShippingMethodTranslation] query construction
abstract final class ShippingMethodTranslationFields {
  static const createdAt = Field<ShippingMethodTranslation, DateTime?>(
    'createdAt',
    _$createdAt,
  );

  static const description = Field<ShippingMethodTranslation, String?>(
    'description',
    _$description,
  );

  static const id = Field<ShippingMethodTranslation, String?>('id', _$id);

  static const languageCode = Field<ShippingMethodTranslation, LanguageCode?>(
    'languageCode',
    _$languageCode,
  );

  static const name = Field<ShippingMethodTranslation, String?>('name', _$name);

  static const updatedAt = Field<ShippingMethodTranslation, DateTime?>(
    'updatedAt',
    _$updatedAt,
  );

  static DateTime? _$createdAt(ShippingMethodTranslation e) {
    return e.createdAt;
  }

  static String? _$description(ShippingMethodTranslation e) {
    return e.description;
  }

  static String? _$id(ShippingMethodTranslation e) {
    return e.id;
  }

  static LanguageCode? _$languageCode(ShippingMethodTranslation e) {
    return e.languageCode;
  }

  static String? _$name(ShippingMethodTranslation e) {
    return e.name;
  }

  static DateTime? _$updatedAt(ShippingMethodTranslation e) {
    return e.updatedAt;
  }
}

extension ShippingMethodTranslationCompareE on ShippingMethodTranslation {
  Map<String, dynamic> compareToShippingMethodTranslation(
    ShippingMethodTranslation other,
  ) {
