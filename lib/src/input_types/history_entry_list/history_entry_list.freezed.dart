...
as List<HistoryEntry?>?,totalItems: freezed == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
class _HistoryEntryList extends HistoryEntryList {
  const _HistoryEntryList({final  List<HistoryEntry?>? items, this.totalItems}): _items = items,super._();
