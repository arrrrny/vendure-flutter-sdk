...
/// Create a copy of Role
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? channels = freezed,Object? code = freezed,Object? createdAt = freezed,Object? description = freezed,Object? id = freezed,Object? permissions = freezed,Object? updatedAt = freezed,}) {
  return _then(_self.copyWith(
channels: freezed == channels ? _self.channels : channels // ignore: cast_nullable_to_non_nullable
as List<Channel?>?,code: freezed == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
...
as List<Permission?>?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
class _Role extends Role {
  const _Role({final  List<Channel?>? channels, this.code, this.createdAt, this.description, this.id, final  List<Permission?>? permissions, this.updatedAt}): _channels = channels,_permissions = permissions,super._();
...
/// Create a copy of Role
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? channels = freezed,Object? code = freezed,Object? createdAt = freezed,Object? description = freezed,Object? id = freezed,Object? permissions = freezed,Object? updatedAt = freezed,}) {
  return _then(_Role(
