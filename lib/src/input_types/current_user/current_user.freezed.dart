...
/// Create a copy of CurrentUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? channels = freezed,Object? id = freezed,Object? identifier = freezed,}) {
...
class _CurrentUser extends CurrentUser {
  const _CurrentUser({final  List<CurrentUserChannel?>? channels, this.id, this.identifier}): _channels = channels,super._();
...
/// Create a copy of CurrentUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? channels = freezed,Object? id = freezed,Object? identifier = freezed,}) {
