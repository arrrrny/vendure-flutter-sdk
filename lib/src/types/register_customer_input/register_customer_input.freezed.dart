...
mixin _$RegisterCustomerInput {
 ...
 String get emailAddress; set emailAddress(String value); String? get firstName; set firstName(String? value); String? get lastName; set lastName(String? value); String? get password; set password(String? value); String? get phoneNumber; set phoneNumber(String? value); String? get title; set title(String? value);
...
class _RegisterCustomerInput extends RegisterCustomerInput {
   _RegisterCustomerInput({required this.emailAddress, this.firstName, this.lastName, this.password, this.phoneNumber, this.title}): super._();
