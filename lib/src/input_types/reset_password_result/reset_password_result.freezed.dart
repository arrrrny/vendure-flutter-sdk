...
class PasswordResetTokenExpiredError extends ResetPasswordResult {
  const PasswordResetTokenExpiredError({this.errorCode, this.message, final  String? $type}): $type = $type ?? 'passwordResetTokenExpiredError',super._();
...
class PasswordResetTokenInvalidError extends ResetPasswordResult {
  const PasswordResetTokenInvalidError({this.errorCode, this.message, final  String? $type}): $type = $type ?? 'passwordResetTokenInvalidError',super._();
