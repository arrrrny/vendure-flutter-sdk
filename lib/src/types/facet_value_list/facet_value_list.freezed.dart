...
as List<FacetValue>,totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _FacetValueList extends FacetValueList {
  const _FacetValueList({required final  List<FacetValue> items, required this.totalItems}): _items = items,super._();
