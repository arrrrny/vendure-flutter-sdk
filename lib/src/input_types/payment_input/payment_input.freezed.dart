...
class _$PaymentInputImpl extends _PaymentInput with DiagnosticableTreeMixin {
  const _$PaymentInputImpl(
      {required final Map<String, dynamic> metadata, required this.method})
      : _metadata = metadata,
        super._();
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_metadata), method);
...
abstract class _PaymentInput extends PaymentInput {
  const factory _PaymentInput(
      ...
      required final String method}) = _$PaymentInputImpl;
  const _PaymentInput._() : super._();
