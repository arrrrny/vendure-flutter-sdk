...
mixin _$FacetValue {
 ...
 String? get code; DateTime? get createdAt; Map<String, dynamic>? get customFields; Facet? get facet; String? get facetId; String? get id; LanguageCode? get languageCode; String? get name; List<FacetValueTranslation?>? get translations; DateTime? get updatedAt;
...
@useResult
$Res call({
 String? code, DateTime? createdAt, Map<String, dynamic>? customFields, Facet? facet, String? facetId, String? id, LanguageCode? languageCode, String? name, List<FacetValueTranslation?>? translations, DateTime? updatedAt
});
...
/// Create a copy of FacetValue
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = freezed,Object? createdAt = freezed,Object? customFields = freezed,Object? facet = freezed,Object? facetId = freezed,Object? id = freezed,Object? languageCode = freezed,Object? name = freezed,Object? translations = freezed,Object? updatedAt = freezed,}) {
...
as Map<String, dynamic>?,facet: freezed == facet ? _self.facet : facet // ignore: cast_nullable_to_non_nullable
as Facet?,facetId: freezed == facetId ? _self.facetId : facetId // ignore: cast_nullable_to_non_nullable
...
as List<FacetValueTranslation?>?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
/// Create a copy of FacetValue
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? code,  DateTime? createdAt,  Map<String, dynamic>? customFields,  Facet? facet,  String? facetId,  String? id,  LanguageCode? languageCode,  String? name,  List<FacetValueTranslation?>? translations,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FacetValue() when $default != null:
return $default(_that.code,_that.createdAt,_that.customFields,_that.facet,_that.facetId,_that.id,_that.languageCode,_that.name,_that.translations,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? code,  DateTime? createdAt,  Map<String, dynamic>? customFields,  Facet? facet,  String? facetId,  String? id,  LanguageCode? languageCode,  String? name,  List<FacetValueTranslation?>? translations,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _FacetValue():
return $default(_that.code,_that.createdAt,_that.customFields,_that.facet,_that.facetId,_that.id,_that.languageCode,_that.name,_that.translations,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? code,  DateTime? createdAt,  Map<String, dynamic>? customFields,  Facet? facet,  String? facetId,  String? id,  LanguageCode? languageCode,  String? name,  List<FacetValueTranslation?>? translations,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _FacetValue() when $default != null:
return $default(_that.code,_that.createdAt,_that.customFields,_that.facet,_that.facetId,_that.id,_that.languageCode,_that.name,_that.translations,_that.updatedAt);case _:
  return null;
...
class _FacetValue extends FacetValue {
  const _FacetValue({this.code, this.createdAt, final  Map<String, dynamic>? customFields, this.facet, this.facetId, this.id, this.languageCode, this.name, final  List<FacetValueTranslation?>? translations, this.updatedAt}): _customFields = customFields,_translations = translations,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,createdAt,const DeepCollectionEquality().hash(_customFields),facet,facetId,id,languageCode,name,const DeepCollectionEquality().hash(_translations),updatedAt);
...
/// Create a copy of FacetValue
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = freezed,Object? createdAt = freezed,Object? customFields = freezed,Object? facet = freezed,Object? facetId = freezed,Object? id = freezed,Object? languageCode = freezed,Object? name = freezed,Object? translations = freezed,Object? updatedAt = freezed,}) {
