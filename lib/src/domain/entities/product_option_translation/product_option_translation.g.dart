...
ProductOptionTranslation _$ProductOptionTranslationFromJson(Map json) =>
    $checkedCreate('ProductOptionTranslation', json, ($checkedConvert) {
      final val = ProductOptionTranslation(
...
Map<String, dynamic> _$ProductOptionTranslationToJson(
  ProductOptionTranslation instance,
) => <String, dynamic>{
