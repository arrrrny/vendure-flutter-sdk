...
mixin _$FacetValueFilterInput {
 ...
 String? get and; List<String>? get or;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FacetValueFilterInput&&(identical(other.and, and) || other.and == and)&&const DeepCollectionEquality().equals(other.or, or));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,and,const DeepCollectionEquality().hash(or));
...
class _FacetValueFilterInput extends FacetValueFilterInput {
  const _FacetValueFilterInput({this.and, final  List<String>? or}): _or = or,super._();
  factory _FacetValueFilterInput.fromJson(Map<String, dynamic> json) => _$FacetValueFilterInputFromJson(json);

@override final  String? and;
 final  List<String>? _or;
@override List<String>? get or {
  final value = _or;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FacetValueFilterInput&&(identical(other.and, and) || other.and == and)&&const DeepCollectionEquality().equals(other._or, _or));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,and,const DeepCollectionEquality().hash(_or));
...
and: freezed == and ? _self.and : and // ignore: cast_nullable_to_non_nullable
as String?,or: freezed == or ? _self._or : or // ignore: cast_nullable_to_non_nullable
as List<String>?,
  ));
}
