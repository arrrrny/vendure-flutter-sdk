...
as List<TaxRate>,totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _TaxRateList extends TaxRateList {
  const _TaxRateList({required final  List<TaxRate> items, required this.totalItems}): _items = items,super._();
