...
as List<ShippingMethod>,totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _ShippingMethodList extends ShippingMethodList {
  const _ShippingMethodList({required final  List<ShippingMethod> items, required this.totalItems}): _items = items,super._();
