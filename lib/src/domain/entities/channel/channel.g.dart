...
Channel _$ChannelFromJson(Map json) => $checkedCreate('Channel', json, (
  $checkedConvert,
) {
  final val = Channel(
    availableCurrencyCodes: $checkedConvert(
    ...
    defaultCurrencyCode: $checkedConvert(
      'defaultCurrencyCode',
      (v) => $enumDecodeNullable(_$CurrencyCodeEnumMap, v),
    ),
    defaultLanguageCode: $checkedConvert(
      'defaultLanguageCode',
      (v) => $enumDecodeNullable(_$LanguageCodeEnumMap, v),
    ),
    defaultShippingZone: $checkedConvert(
      'defaultShippingZone',
      (v) =>
          v == null ? null : Zone.fromJson(Map<String, dynamic>.from(v as Map)),
    ),
    defaultTaxZone: $checkedConvert(
      'defaultTaxZone',
      (v) =>
          v == null ? null : Zone.fromJson(Map<String, dynamic>.from(v as Map)),
    ),
    id: $checkedConvert('id', (v) => v as String?),
    outOfStockThreshold: $checkedConvert(
      'outOfStockThreshold',
      (v) => (v as num?)?.toInt(),
    ),
    pricesIncludeTax: $checkedConvert('pricesIncludeTax', (v) => v as bool?),
    seller: $checkedConvert(
      'seller',
      (v) => v == null
          ? null
          : Seller.fromJson(Map<String, dynamic>.from(v as Map)),
    ),
    token: $checkedConvert('token', (v) => v as String?),
    trackInventory: $checkedConvert('trackInventory', (v) => v as bool?),
