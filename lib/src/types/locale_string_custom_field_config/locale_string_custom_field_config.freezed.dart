...
class _LocaleStringCustomFieldConfig extends LocaleStringCustomFieldConfig {
  const _LocaleStringCustomFieldConfig({final  List<LocalizedString>? description, this.internal, final  List<LocalizedString>? label, this.length, required this.list, required this.name, this.nullable, this.pattern, this.readonly, final  List<Permission>? requiresPermission, required this.type, final  Map<String, dynamic>? ui}): _description = description,_label = label,_requiresPermission = requiresPermission,_ui = ui,super._();
