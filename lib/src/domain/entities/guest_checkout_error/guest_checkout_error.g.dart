...
GuestCheckoutError _$GuestCheckoutErrorFromJson(Map json) =>
    $checkedCreate('GuestCheckoutError', json, ($checkedConvert) {
      final val = GuestCheckoutError(
        errorCode: $checkedConvert(
          'errorCode',
          (v) => $enumDecodeNullable(_$ErrorCodeEnumMap, v),
        ),
        errorDetail: $checkedConvert('errorDetail', (v) => v as String?),
