...
class AlreadyLoggedInError extends SetCustomerForOrderResult {
  const AlreadyLoggedInError({this.errorCode, this.message, final  String? $type}): $type = $type ?? 'alreadyLoggedInError',super._();
...
class GuestCheckoutError extends SetCustomerForOrderResult {
  const GuestCheckoutError({this.errorCode, this.errorDetail, this.message, final  String? $type}): $type = $type ?? 'guestCheckoutError',super._();
...
/// Create a copy of SetCustomerForOrderResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? errorCode = freezed,Object? errorDetail = freezed,Object? message = freezed,}) {
