...
/// Create a copy of LocalizedString
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? languageCode = freezed,Object? value = freezed,}) {
  return _then(_self.copyWith(
languageCode: freezed == languageCode ? _self.languageCode : languageCode // ignore: cast_nullable_to_non_nullable
as LanguageCode?,value: freezed == value ? _self.value : value // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
class _LocalizedString extends LocalizedString {
  const _LocalizedString({this.languageCode, this.value}): super._();
...
/// Create a copy of LocalizedString
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? languageCode = freezed,Object? value = freezed,}) {
