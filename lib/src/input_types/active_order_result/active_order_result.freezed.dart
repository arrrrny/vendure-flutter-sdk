...
part of 'active_order_result.dart';
...
ActiveOrderResult _$ActiveOrderResultFromJson(
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ActiveOrderResult);
}
...
/// @nodoc
class $ActiveOrderResultCopyWith<$Res>  {
$ActiveOrderResultCopyWith(ActiveOrderResult _, $Res Function(ActiveOrderResult) __);
}


/// Adds pattern-matching-related methods to [ActiveOrderResult].
extension ActiveOrderResultPatterns on ActiveOrderResult {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( NoActiveOrderError value)?  noActiveOrderError,TResult Function( Order value)?  order,required TResult orElse(),}){
final _that = this;
switch (_that) {
case NoActiveOrderError() when noActiveOrderError != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( NoActiveOrderError value)  noActiveOrderError,required TResult Function( Order value)  order,}){
final _that = this;
switch (_that) {
case NoActiveOrderError():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( NoActiveOrderError value)?  noActiveOrderError,TResult? Function( Order value)?  order,}){
final _that = this;
switch (_that) {
case NoActiveOrderError() when noActiveOrderError != null:
return noActiveOrderError(_that);case Order() when order != null:
...
@override
String toString() {
  return 'ActiveOrderResult.noActiveOrderError(errorCode: $errorCode, message: $message)';
}
...
/// @nodoc
abstract mixin class $NoActiveOrderErrorCopyWith<$Res> implements $ActiveOrderResultCopyWith<$Res> {
...
/// @nodoc
abstract mixin class $OrderCopyWith<$Res> implements $ActiveOrderResultCopyWith<$Res> {
