...
as List<Tag>,totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _TagList extends TagList {
  const _TagList({required final  List<Tag> items, required this.totalItems}): _items = items,super._();
