...
/// Create a copy of CustomerGroup
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = freezed,Object? customFields = freezed,Object? customers = freezed,Object? id = freezed,Object? name = freezed,Object? updatedAt = freezed,}) {
...
as Map<String, dynamic>?,customers: freezed == customers ? _self.customers : customers // ignore: cast_nullable_to_non_nullable
as CustomerList?,id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
class _CustomerGroup extends CustomerGroup {
  const _CustomerGroup({this.createdAt, final  Map<String, dynamic>? customFields, this.customers, this.id, this.name, this.updatedAt}): _customFields = customFields,super._();
...
/// Create a copy of CustomerGroup
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? createdAt = freezed,Object? customFields = freezed,Object? customers = freezed,Object? id = freezed,Object? name = freezed,Object? updatedAt = freezed,}) {
