...
class DateTimeCustomFieldConfig extends CustomFieldConfig {
  const DateTimeCustomFieldConfig({final  List<LocalizedString?>? description, this.internal, final  List<LocalizedString?>? label, this.list, this.max, this.min, this.name, this.nullable, this.readonly, final  List<Permission?>? requiresPermission, this.step, this.type, final  Map<String, dynamic>? ui, final  String? $type}): _description = description,_label = label,_requiresPermission = requiresPermission,_ui = ui,$type = $type ?? 'dateTimeCustomFieldConfig',super._();
...
class LocaleStringCustomFieldConfig extends CustomFieldConfig {
  const LocaleStringCustomFieldConfig({final  List<LocalizedString?>? description, this.internal, final  List<LocalizedString?>? label, this.length, this.list, this.name, this.nullable, this.pattern, this.readonly, final  List<Permission?>? requiresPermission, this.type, final  Map<String, dynamic>? ui, final  String? $type}): _description = description,_label = label,_requiresPermission = requiresPermission,_ui = ui,$type = $type ?? 'localeStringCustomFieldConfig',super._();
...
class RelationCustomFieldConfig extends CustomFieldConfig {
  const RelationCustomFieldConfig({final  List<LocalizedString?>? description, this.entity, this.internal, final  List<LocalizedString?>? label, this.list, this.name, this.nullable, this.readonly, final  List<Permission?>? requiresPermission, final  List<String?>? scalarFields, this.type, final  Map<String, dynamic>? ui, final  String? $type}): _description = description,_label = label,_requiresPermission = requiresPermission,_scalarFields = scalarFields,_ui = ui,$type = $type ?? 'relationCustomFieldConfig',super._();
...
/// Create a copy of CustomFieldConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? description = freezed,Object? entity = freezed,Object? internal = freezed,Object? label = freezed,Object? list = freezed,Object? name = freezed,Object? nullable = freezed,Object? readonly = freezed,Object? requiresPermission = freezed,Object? scalarFields = freezed,Object? type = freezed,Object? ui = freezed,}) {
  return _then(RelationCustomFieldConfig(
description: freezed == description ? _self._description : description // ignore: cast_nullable_to_non_nullable
as List<LocalizedString?>?,entity: freezed == entity ? _self.entity : entity // ignore: cast_nullable_to_non_nullable
...
as bool?,readonly: freezed == readonly ? _self.readonly : readonly // ignore: cast_nullable_to_non_nullable
as bool?,requiresPermission: freezed == requiresPermission ? _self._requiresPermission : requiresPermission // ignore: cast_nullable_to_non_nullable
as List<Permission?>?,scalarFields: freezed == scalarFields ? _self._scalarFields : scalarFields // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of CustomFieldConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? description = freezed,Object? internal = freezed,Object? label = freezed,Object? length = freezed,Object? list = freezed,Object? name = freezed,Object? nullable = freezed,Object? options = freezed,Object? pattern = freezed,Object? readonly = freezed,Object? requiresPermission = freezed,Object? type = freezed,Object? ui = freezed,}) {
