...
mixin _$HistoryEntrySortParameter {
 ...
 SortOrder? get createdAt; set createdAt(SortOrder? value); SortOrder? get id; set id(SortOrder? value); SortOrder? get updatedAt; set updatedAt(SortOrder? value);
...
class _HistoryEntrySortParameter extends HistoryEntrySortParameter {
   _HistoryEntrySortParameter({this.createdAt, this.id, this.updatedAt}): super._();
