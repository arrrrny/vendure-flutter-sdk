...
class PaymentMethodTranslation {
  ...
  PaymentMethodTranslation copyWith({
    DateTime? createdAt,
    String? description,
    String? id,
  ...
  PaymentMethodTranslation copyWithPaymentMethodTranslation({
    DateTime? createdAt,
    String? description,
    String? id,
    LanguageCode? languageCode,
  ...
  PaymentMethodTranslation patchWithPaymentMethodTranslation([
    PaymentMethodTranslationPatch? patchInput,
  ]) {
    final _patcher = patchInput ?? PaymentMethodTranslationPatch();
    final _patchMap = _patcher.patchMap;
    return PaymentMethodTranslation(
      createdAt: _patchMap.containsKey(PaymentMethodTranslation$.createdAt)
          ? (_patchMap[PaymentMethodTranslation$.createdAt] is Function)
                ? _patchMap[PaymentMethodTranslation$.createdAt](this.createdAt)
                : (_patchMap[PaymentMethodTranslation$.createdAt] is Patch)
                ? _patchMap[PaymentMethodTranslation$.createdAt].applyTo(
                    this.createdAt,
                  )
                : _patchMap[PaymentMethodTranslation$.createdAt]
          : this.createdAt,
      description: _patchMap.containsKey(PaymentMethodTranslation$.description)
          ? (_patchMap[PaymentMethodTranslation$.description] is Function)
                ? _patchMap[PaymentMethodTranslation$.description](
                    this.description,
                  )
                : (_patchMap[PaymentMethodTranslation$.description] is Patch)
                ? _patchMap[PaymentMethodTranslation$.description].applyTo(
                    this.description,
                  )
                : _patchMap[PaymentMethodTranslation$.description]
          : this.description,
      id: _patchMap.containsKey(PaymentMethodTranslation$.id)
          ? (_patchMap[PaymentMethodTranslation$.id] is Function)
                ? _patchMap[PaymentMethodTranslation$.id](this.id)
                : (_patchMap[PaymentMethodTranslation$.id] is Patch)
                ? _patchMap[PaymentMethodTranslation$.id].applyTo(this.id)
                : _patchMap[PaymentMethodTranslation$.id]
          : this.id,
      languageCode:
          _patchMap.containsKey(PaymentMethodTranslation$.languageCode)
          ? (_patchMap[PaymentMethodTranslation$.languageCode] is Function)
                ? _patchMap[PaymentMethodTranslation$.languageCode](
                    this.languageCode,
                  )
                : (_patchMap[PaymentMethodTranslation$.languageCode] is Patch)
                ? _patchMap[PaymentMethodTranslation$.languageCode].applyTo(
                    this.languageCode,
                  )
                : _patchMap[PaymentMethodTranslation$.languageCode]
          : this.languageCode,
      name: _patchMap.containsKey(PaymentMethodTranslation$.name_)
          ? (_patchMap[PaymentMethodTranslation$.name_] is Function)
                ? _patchMap[PaymentMethodTranslation$.name_](this.name)
                : (_patchMap[PaymentMethodTranslation$.name_] is Patch)
                ? _patchMap[PaymentMethodTranslation$.name_].applyTo(this.name)
                : _patchMap[PaymentMethodTranslation$.name_]
          : this.name,
      updatedAt: _patchMap.containsKey(PaymentMethodTranslation$.updatedAt)
          ? (_patchMap[PaymentMethodTranslation$.updatedAt] is Function)
                ? _patchMap[PaymentMethodTranslation$.updatedAt](this.updatedAt)
                : (_patchMap[PaymentMethodTranslation$.updatedAt] is Patch)
                ? _patchMap[PaymentMethodTranslation$.updatedAt].applyTo(
                    this.updatedAt,
                  )
                : _patchMap[PaymentMethodTranslation$.updatedAt]
          : this.updatedAt,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is PaymentMethodTranslation &&
  ...
  Map<String, dynamic> toJsonLean() {
    final Map<String, dynamic> data = _$PaymentMethodTranslationToJson(this);
...
extension PaymentMethodTranslationPropertyHelpers on PaymentMethodTranslation {
...
extension PaymentMethodTranslationSerialization on PaymentMethodTranslation {
  Map<String, dynamic> toJson() {
    return _$PaymentMethodTranslationToJson(this);
  }
}

enum PaymentMethodTranslation$ {
  createdAt,
  description,
  id,
  languageCode,
...
class PaymentMethodTranslationPatch
    extends PatchBase<PaymentMethodTranslation, PaymentMethodTranslation$> {
  PaymentMethodTranslation applyTo(PaymentMethodTranslation entity) {
    return entity.patchWithPaymentMethodTranslation(this);
  }

  PaymentMethodTranslationPatch withCreatedAt(DateTime? value) {
    patchMap[PaymentMethodTranslation$.createdAt] = value;
    return this;
  }

  PaymentMethodTranslationPatch withDescription(String? value) {
    patchMap[PaymentMethodTranslation$.description] = value;
    return this;
  }

  PaymentMethodTranslationPatch withId(String? value) {
    patchMap[PaymentMethodTranslation$.id] = value;
    return this;
  }

  PaymentMethodTranslationPatch withLanguageCode(LanguageCode? value) {
    patchMap[PaymentMethodTranslation$.languageCode] = value;
    return this;
  }

  PaymentMethodTranslationPatch withName(String? value) {
    patchMap[PaymentMethodTranslation$.name_] = value;
    return this;
  }

  PaymentMethodTranslationPatch withUpdatedAt(DateTime? value) {
    patchMap[PaymentMethodTranslation$.updatedAt] = value;
    return this;
  }
}

/// Field descriptors for [PaymentMethodTranslation] query construction
abstract final class PaymentMethodTranslationFields {
  static const createdAt = Field<PaymentMethodTranslation, DateTime?>(
    'createdAt',
    _$createdAt,
  );

  static const description = Field<PaymentMethodTranslation, String?>(
    'description',
    _$description,
  );

  static const id = Field<PaymentMethodTranslation, String?>('id', _$id);

  static const languageCode = Field<PaymentMethodTranslation, LanguageCode?>(
    'languageCode',
    _$languageCode,
  );

  static const name = Field<PaymentMethodTranslation, String?>('name', _$name);

  static const updatedAt = Field<PaymentMethodTranslation, DateTime?>(
    'updatedAt',
    _$updatedAt,
  );

  static DateTime? _$createdAt(PaymentMethodTranslation e) {
    return e.createdAt;
  }

  static String? _$description(PaymentMethodTranslation e) {
    return e.description;
  }

  static String? _$id(PaymentMethodTranslation e) {
    return e.id;
  }

  static LanguageCode? _$languageCode(PaymentMethodTranslation e) {
    return e.languageCode;
  }

  static String? _$name(PaymentMethodTranslation e) {
    return e.name;
  }

  static DateTime? _$updatedAt(PaymentMethodTranslation e) {
    return e.updatedAt;
  }
}

extension PaymentMethodTranslationCompareE on PaymentMethodTranslation {
  Map<String, dynamic> compareToPaymentMethodTranslation(
    PaymentMethodTranslation other,
  ) {
