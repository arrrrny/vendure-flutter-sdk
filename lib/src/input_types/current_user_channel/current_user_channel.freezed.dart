...
mixin _$CurrentUserChannel {
 ...
 String? get code; String? get id; List<Permission?>? get permissions; String? get token;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CurrentUserChannel&&(identical(other.code, code) || other.code == code)&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.permissions, permissions)&&(identical(other.token, token) || other.token == token));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,id,const DeepCollectionEquality().hash(permissions),token);
...
/// Create a copy of CurrentUserChannel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = freezed,Object? id = freezed,Object? permissions = freezed,Object? token = freezed,}) {
...
as List<Permission?>?,token: freezed == token ? _self.token : token // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? code,  String? id,  List<Permission?>? permissions,  String? token)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CurrentUserChannel() when $default != null:
return $default(_that.code,_that.id,_that.permissions,_that.token);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? code,  String? id,  List<Permission?>? permissions,  String? token)  $default,) {final _that = this;
switch (_that) {
case _CurrentUserChannel():
return $default(_that.code,_that.id,_that.permissions,_that.token);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? code,  String? id,  List<Permission?>? permissions,  String? token)?  $default,) {final _that = this;
switch (_that) {
case _CurrentUserChannel() when $default != null:
return $default(_that.code,_that.id,_that.permissions,_that.token);case _:
  return null;
...
class _CurrentUserChannel extends CurrentUserChannel {
  const _CurrentUserChannel({this.code, this.id, final  List<Permission?>? permissions, this.token}): _permissions = permissions,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CurrentUserChannel&&(identical(other.code, code) || other.code == code)&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other._permissions, _permissions)&&(identical(other.token, token) || other.token == token));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,id,const DeepCollectionEquality().hash(_permissions),token);
...
/// Create a copy of CurrentUserChannel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = freezed,Object? id = freezed,Object? permissions = freezed,Object? token = freezed,}) {
