...
class AddPaymentToOrderResult with _$AddPaymentToOrderResult {
  ...
  const factory AddPaymentToOrderResult.noActiveOrderError({
    ErrorCode? errorCode,
    String? message,
  }) = NoActiveOrderError;

  const factory AddPaymentToOrderResult.order({
  ...
  const factory AddPaymentToOrderResult.orderPaymentStateError({
    ErrorCode? errorCode,
    String? message,
  }) = OrderPaymentStateError;

  const factory AddPaymentToOrderResult.orderStateTransitionError({
    ErrorCode? errorCode,
    String? fromState,
    String? message,
    String? toState,
  ...
  const factory AddPaymentToOrderResult.paymentDeclinedError({
    ErrorCode? errorCode,
    String? message,
    String? paymentErrorMessage,
  }) = PaymentDeclinedError;

  const factory AddPaymentToOrderResult.paymentFailedError({
    ErrorCode? errorCode,
    String? message,
    String? paymentErrorMessage,
  }) = PaymentFailedError;
  ...
  factory AddPaymentToOrderResult.fromJson(Map<String, dynamic> json) =>
      _$AddPaymentToOrderResultFromJson(json);
}
