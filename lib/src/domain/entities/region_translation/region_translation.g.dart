...
RegionTranslation _$RegionTranslationFromJson(Map json) =>
    $checkedCreate('RegionTranslation', json, ($checkedConvert) {
      final val = RegionTranslation(
...
Map<String, dynamic> _$RegionTranslationToJson(RegionTranslation instance) =>
    <String, dynamic>{
