...
as List<Permission?>?,scalarFields: freezed == scalarFields ? _self.scalarFields : scalarFields // ignore: cast_nullable_to_non_nullable
...
class _RelationCustomFieldConfig extends RelationCustomFieldConfig {
  const _RelationCustomFieldConfig({final  List<LocalizedString?>? description, this.entity, this.internal, final  List<LocalizedString?>? label, this.list, this.name, this.nullable, this.readonly, final  List<Permission?>? requiresPermission, final  List<String?>? scalarFields, this.type, final  Map<String, dynamic>? ui}): _description = description,_label = label,_requiresPermission = requiresPermission,_scalarFields = scalarFields,_ui = ui,super._();
