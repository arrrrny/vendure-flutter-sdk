...
as List<Role?>?,totalItems: freezed == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
class _RoleList extends RoleList {
  const _RoleList({final  List<Role?>? items, this.totalItems}): _items = items,super._();
