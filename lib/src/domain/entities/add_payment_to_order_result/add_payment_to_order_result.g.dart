...
OrderPaymentStateError _$OrderPaymentStateErrorFromJson(Map json) =>
    OrderPaymentStateError(
      errorCode: $enumDecodeNullable(_$ErrorCodeEnumMap, json['errorCode']),
      message: json['message'] as String?,
    );

Map<String, dynamic> _$OrderPaymentStateErrorToJson(
  OrderPaymentStateError instance,
) => <String, dynamic>{
  'errorCode': ?_$ErrorCodeEnumMap[instance.errorCode],
  'message': ?instance.message,
};
...
PaymentDeclinedError _$PaymentDeclinedErrorFromJson(Map json) =>
...
PaymentFailedError _$PaymentFailedErrorFromJson(Map json) => PaymentFailedError(
  errorCode: $enumDecodeNullable(_$ErrorCodeEnumMap, json['errorCode']),
  message: json['message'] as String?,
  paymentErrorMessage: json['paymentErrorMessage'] as String?,
);

Map<String, dynamic> _$PaymentFailedErrorToJson(PaymentFailedError instance) =>
    <String, dynamic>{
      'errorCode': ?_$ErrorCodeEnumMap[instance.errorCode],
      'message': ?instance.message,
      'paymentErrorMessage': ?instance.paymentErrorMessage,
