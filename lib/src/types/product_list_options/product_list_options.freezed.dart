...
/// Allows the results to be filtered
 ProductFilterParameter? get filter;/// Allows the results to be filtered
 set filter(ProductFilterParameter? value);/// Specifies whether multiple top-level "filter" fields should be combined with a
...
/// logical AND or OR operation. Defaults to AND.
 ...
 ProductSortParameter? get sort;/// Specifies which properties to sort the results by
 set sort(ProductSortParameter? value);/// Takes n results, for use in pagination
...
class _ProductListOptions extends ProductListOptions {
   _ProductListOptions({this.filter, this.filterOperator, this.skip, this.sort, this.take}): super._();
  factory _ProductListOptions.fromJson(Map<String, dynamic> json) => _$ProductListOptionsFromJson(json);

/// Allows the results to be filtered
@override  ProductFilterParameter? filter;
...
@override  ProductSortParameter? sort;
