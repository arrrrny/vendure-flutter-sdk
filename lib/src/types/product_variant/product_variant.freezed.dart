...
mixin _$ProductVariant {
 ...
 List<Asset> get assets; DateTime get createdAt; CurrencyCode get currencyCode; Map<String, dynamic>? get customFields; List<FacetValue> get facetValues; Asset? get featuredAsset; String get id; LanguageCode get languageCode; String get name; List<ProductOption> get options; double get price; double get priceWithTax; String get productId; String get sku; String get stockLevel; TaxCategory get taxCategory; List<ProductVariantTranslation> get translations; DateTime get updatedAt;
...
@useResult
$Res call({
 List<Asset> assets, DateTime createdAt, CurrencyCode currencyCode, Map<String, dynamic>? customFields, List<FacetValue> facetValues, Asset? featuredAsset, String id, LanguageCode languageCode, String name, List<ProductOption> options, double price, double priceWithTax, String productId, String sku, String stockLevel, TaxCategory taxCategory, List<ProductVariantTranslation> translations, DateTime updatedAt
});


$AssetCopyWith<$Res>? get featuredAsset;$TaxCategoryCopyWith<$Res> get taxCategory;
...
/// Create a copy of ProductVariant
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? assets = null,Object? createdAt = null,Object? currencyCode = null,Object? customFields = freezed,Object? facetValues = null,Object? featuredAsset = freezed,Object? id = null,Object? languageCode = null,Object? name = null,Object? options = null,Object? price = null,Object? priceWithTax = null,Object? productId = null,Object? sku = null,Object? stockLevel = null,Object? taxCategory = null,Object? translations = null,Object? updatedAt = null,}) {
...
as Map<String, dynamic>?,facetValues: null == facetValues ? _self.facetValues : facetValues // ignore: cast_nullable_to_non_nullable
...
as List<ProductOption>,price: null == price ? _self.price : price // ignore: cast_nullable_to_non_nullable
as double,priceWithTax: null == priceWithTax ? _self.priceWithTax : priceWithTax // ignore: cast_nullable_to_non_nullable
as double,productId: null == productId ? _self.productId : productId // ignore: cast_nullable_to_non_nullable
as String,sku: null == sku ? _self.sku : sku // ignore: cast_nullable_to_non_nullable
as String,stockLevel: null == stockLevel ? _self.stockLevel : stockLevel // ignore: cast_nullable_to_non_nullable
as String,taxCategory: null == taxCategory ? _self.taxCategory : taxCategory // ignore: cast_nullable_to_non_nullable
as TaxCategory,translations: null == translations ? _self.translations : translations // ignore: cast_nullable_to_non_nullable
as List<ProductVariantTranslation>,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
/// Create a copy of ProductVariant
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Asset> assets,  DateTime createdAt,  CurrencyCode currencyCode,  Map<String, dynamic>? customFields,  List<FacetValue> facetValues,  Asset? featuredAsset,  String id,  LanguageCode languageCode,  String name,  List<ProductOption> options,  double price,  double priceWithTax,  String productId,  String sku,  String stockLevel,  TaxCategory taxCategory,  List<ProductVariantTranslation> translations,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductVariant() when $default != null:
return $default(_that.assets,_that.createdAt,_that.currencyCode,_that.customFields,_that.facetValues,_that.featuredAsset,_that.id,_that.languageCode,_that.name,_that.options,_that.price,_that.priceWithTax,_that.productId,_that.sku,_that.stockLevel,_that.taxCategory,_that.translations,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Asset> assets,  DateTime createdAt,  CurrencyCode currencyCode,  Map<String, dynamic>? customFields,  List<FacetValue> facetValues,  Asset? featuredAsset,  String id,  LanguageCode languageCode,  String name,  List<ProductOption> options,  double price,  double priceWithTax,  String productId,  String sku,  String stockLevel,  TaxCategory taxCategory,  List<ProductVariantTranslation> translations,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ProductVariant():
return $default(_that.assets,_that.createdAt,_that.currencyCode,_that.customFields,_that.facetValues,_that.featuredAsset,_that.id,_that.languageCode,_that.name,_that.options,_that.price,_that.priceWithTax,_that.productId,_that.sku,_that.stockLevel,_that.taxCategory,_that.translations,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Asset> assets,  DateTime createdAt,  CurrencyCode currencyCode,  Map<String, dynamic>? customFields,  List<FacetValue> facetValues,  Asset? featuredAsset,  String id,  LanguageCode languageCode,  String name,  List<ProductOption> options,  double price,  double priceWithTax,  String productId,  String sku,  String stockLevel,  TaxCategory taxCategory,  List<ProductVariantTranslation> translations,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ProductVariant() when $default != null:
return $default(_that.assets,_that.createdAt,_that.currencyCode,_that.customFields,_that.facetValues,_that.featuredAsset,_that.id,_that.languageCode,_that.name,_that.options,_that.price,_that.priceWithTax,_that.productId,_that.sku,_that.stockLevel,_that.taxCategory,_that.translations,_that.updatedAt);case _:
  return null;
...
class _ProductVariant extends ProductVariant {
  const _ProductVariant({required final  List<Asset> assets, required this.createdAt, required this.currencyCode, final  Map<String, dynamic>? customFields, required final  List<FacetValue> facetValues, this.featuredAsset, required this.id, required this.languageCode, required this.name, required final  List<ProductOption> options, required this.price, required this.priceWithTax, required this.productId, required this.sku, required this.stockLevel, required this.taxCategory, required final  List<ProductVariantTranslation> translations, required this.updatedAt}): _assets = assets,_customFields = customFields,_facetValues = facetValues,_options = options,_translations = translations,super._();
...
@override $AssetCopyWith<$Res>? get featuredAsset;@override $TaxCategoryCopyWith<$Res> get taxCategory;
...
as Map<String, dynamic>?,facetValues: null == facetValues ? _self._facetValues : facetValues // ignore: cast_nullable_to_non_nullable
as List<FacetValue>,featuredAsset: freezed == featuredAsset ? _self.featuredAsset : featuredAsset // ignore: cast_nullable_to_non_nullable
as Asset?,id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,languageCode: null == languageCode ? _self.languageCode : languageCode // ignore: cast_nullable_to_non_nullable
as LanguageCode,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
...
as String,stockLevel: null == stockLevel ? _self.stockLevel : stockLevel // ignore: cast_nullable_to_non_nullable
as String,taxCategory: null == taxCategory ? _self.taxCategory : taxCategory // ignore: cast_nullable_to_non_nullable
as TaxCategory,translations: null == translations ? _self._translations : translations // ignore: cast_nullable_to_non_nullable
as List<ProductVariantTranslation>,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
