...
OrderStateTransitionError _$OrderStateTransitionErrorFromJson(Map json) =>
    $checkedCreate('OrderStateTransitionError', json, ($checkedConvert) {
      final val = OrderStateTransitionError(
        errorCode: $checkedConvert(
          'errorCode',
          (v) => $enumDecodeNullable(_$ErrorCodeEnumMap, v),
        ),
        fromState: $checkedConvert('fromState', (v) => v as String?),
        message: $checkedConvert('message', (v) => v as String?),
        toState: $checkedConvert('toState', (v) => v as String?),
        transitionError: $checkedConvert(
          'transitionError',
          (v) => v as String?,
        ),
      );
