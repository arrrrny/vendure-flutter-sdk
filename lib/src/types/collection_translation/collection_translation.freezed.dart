...
class _CollectionTranslation extends CollectionTranslation {
  const _CollectionTranslation({required this.createdAt, required this.description, required this.id, required this.languageCode, required this.name, required this.slug, required this.updatedAt}): super._();
