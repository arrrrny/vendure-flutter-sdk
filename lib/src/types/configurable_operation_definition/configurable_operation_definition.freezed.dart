...
/// Create a copy of ConfigurableOperationDefinition
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? args = null,Object? code = null,Object? description = null,}) {
  return _then(_self.copyWith(
args: null == args ? _self.args : args // ignore: cast_nullable_to_non_nullable
as List<ConfigArgDefinition>,code: null == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
...
class _ConfigurableOperationDefinition extends ConfigurableOperationDefinition {
  const _ConfigurableOperationDefinition({required final  List<ConfigArgDefinition> args, required this.code, required this.description}): _args = args,super._();
...
/// Create a copy of ConfigurableOperationDefinition
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? args = null,Object? code = null,Object? description = null,}) {
