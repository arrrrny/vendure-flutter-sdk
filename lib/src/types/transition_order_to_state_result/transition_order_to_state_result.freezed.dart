...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TransitionOrderToStateResult);
}
...
@override
String toString() {
  return 'TransitionOrderToStateResult()';
}
...
/// @nodoc
class $TransitionOrderToStateResultCopyWith<$Res>  {
$TransitionOrderToStateResultCopyWith(TransitionOrderToStateResult _, $Res Function(TransitionOrderToStateResult) __);
}


/// Adds pattern-matching-related methods to [TransitionOrderToStateResult].
extension TransitionOrderToStateResultPatterns on TransitionOrderToStateResult {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( Order value)?  order,TResult Function( OrderStateTransitionError value)?  orderStateTransitionError,required TResult orElse(),}){
final _that = this;
switch (_that) {
case Order() when order != null:
return order(_that);case OrderStateTransitionError() when orderStateTransitionError != null:
return orderStateTransitionError(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( Order value)  order,required TResult Function( OrderStateTransitionError value)  orderStateTransitionError,}){
final _that = this;
switch (_that) {
case Order():
return order(_that);case OrderStateTransitionError():
return orderStateTransitionError(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Order value)?  order,TResult? Function( OrderStateTransitionError value)?  orderStateTransitionError,}){
final _that = this;
switch (_that) {
case Order() when order != null:
return order(_that);case OrderStateTransitionError() when orderStateTransitionError != null:
...
/// @nodoc
abstract mixin class $OrderCopyWith<$Res> implements $TransitionOrderToStateResultCopyWith<$Res> {
...
/// @nodoc
abstract mixin class $OrderStateTransitionErrorCopyWith<$Res> implements $TransitionOrderToStateResultCopyWith<$Res> {
