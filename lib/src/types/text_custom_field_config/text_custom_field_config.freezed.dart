...
$TextCustomFieldConfigCopyWith<TextCustomFieldConfig> get copyWith => _$TextCustomFieldConfigCopyWithImpl<TextCustomFieldConfig>(this as TextCustomFieldConfig, _$identity);
...
/// @nodoc
abstract mixin class $TextCustomFieldConfigCopyWith<$Res>  {
...
/// Adds pattern-matching-related methods to [TextCustomFieldConfig].
extension TextCustomFieldConfigPatterns on TextCustomFieldConfig {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TextCustomFieldConfig value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TextCustomFieldConfig() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TextCustomFieldConfig value)  $default,){
final _that = this;
switch (_that) {
case _TextCustomFieldConfig():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TextCustomFieldConfig value)?  $default,){
final _that = this;
switch (_that) {
case _TextCustomFieldConfig() when $default != null:
return $default(_that);case _:
...
class _TextCustomFieldConfig extends TextCustomFieldConfig {
  const _TextCustomFieldConfig({final  List<LocalizedString>? description, this.internal, final  List<LocalizedString>? label, required this.list, required this.name, this.nullable, this.readonly, final  List<Permission>? requiresPermission, required this.type, final  Map<String, dynamic>? ui}): _description = description,_label = label,_requiresPermission = requiresPermission,_ui = ui,super._();
  factory _TextCustomFieldConfig.fromJson(Map<String, dynamic> json) => _$TextCustomFieldConfigFromJson(json);
...
@pragma('vm:prefer-inline')
_$TextCustomFieldConfigCopyWith<_TextCustomFieldConfig> get copyWith => __$TextCustomFieldConfigCopyWithImpl<_TextCustomFieldConfig>(this, _$identity);
...
/// @nodoc
abstract mixin class _$TextCustomFieldConfigCopyWith<$Res> implements $TextCustomFieldConfigCopyWith<$Res> {
  factory _$TextCustomFieldConfigCopyWith(_TextCustomFieldConfig value, $Res Function(_TextCustomFieldConfig) _then) = __$TextCustomFieldConfigCopyWithImpl;
@override @useResult
$Res call({
 List<LocalizedString>? description, bool? internal, List<LocalizedString>? label, bool list, String name, bool? nullable, bool? readonly, List<Permission>? requiresPermission, String type, Map<String, dynamic>? ui
});
...
/// @nodoc
class __$TextCustomFieldConfigCopyWithImpl<$Res>
    implements _$TextCustomFieldConfigCopyWith<$Res> {
  __$TextCustomFieldConfigCopyWithImpl(this._self, this._then);

  final _TextCustomFieldConfig _self;
  final $Res Function(_TextCustomFieldConfig) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? description = freezed,Object? internal = freezed,Object? label = freezed,Object? list = null,Object? name = null,Object? nullable = freezed,Object? readonly = freezed,Object? requiresPermission = freezed,Object? type = null,Object? ui = freezed,}) {
  return _then(_TextCustomFieldConfig(
