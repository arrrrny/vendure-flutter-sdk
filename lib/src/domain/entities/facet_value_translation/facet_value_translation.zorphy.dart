...
class FacetValueTranslation {
  ...
  FacetValueTranslation copyWith({
    DateTime? createdAt,
    String? id,
  ...
  FacetValueTranslation copyWithFacetValueTranslation({
    DateTime? createdAt,
    String? id,
    LanguageCode? languageCode,
    String? name,
  ...
  FacetValueTranslation patchWithFacetValueTranslation([
    FacetValueTranslationPatch? patchInput,
  ]) {
    final _patcher = patchInput ?? FacetValueTranslationPatch();
    final _patchMap = _patcher.patchMap;
    return FacetValueTranslation(
      createdAt: _patchMap.containsKey(FacetValueTranslation$.createdAt)
          ? (_patchMap[FacetValueTranslation$.createdAt] is Function)
                ? _patchMap[FacetValueTranslation$.createdAt](this.createdAt)
                : (_patchMap[FacetValueTranslation$.createdAt] is Patch)
                ? _patchMap[FacetValueTranslation$.createdAt].applyTo(
                    this.createdAt,
                  )
                : _patchMap[FacetValueTranslation$.createdAt]
          : this.createdAt,
      id: _patchMap.containsKey(FacetValueTranslation$.id)
          ? (_patchMap[FacetValueTranslation$.id] is Function)
                ? _patchMap[FacetValueTranslation$.id](this.id)
                : (_patchMap[FacetValueTranslation$.id] is Patch)
                ? _patchMap[FacetValueTranslation$.id].applyTo(this.id)
                : _patchMap[FacetValueTranslation$.id]
          : this.id,
      languageCode: _patchMap.containsKey(FacetValueTranslation$.languageCode)
          ? (_patchMap[FacetValueTranslation$.languageCode] is Function)
                ? _patchMap[FacetValueTranslation$.languageCode](
                    this.languageCode,
                  )
                : (_patchMap[FacetValueTranslation$.languageCode] is Patch)
                ? _patchMap[FacetValueTranslation$.languageCode].applyTo(
                    this.languageCode,
                  )
                : _patchMap[FacetValueTranslation$.languageCode]
          : this.languageCode,
      name: _patchMap.containsKey(FacetValueTranslation$.name_)
          ? (_patchMap[FacetValueTranslation$.name_] is Function)
                ? _patchMap[FacetValueTranslation$.name_](this.name)
                : (_patchMap[FacetValueTranslation$.name_] is Patch)
                ? _patchMap[FacetValueTranslation$.name_].applyTo(this.name)
                : _patchMap[FacetValueTranslation$.name_]
          : this.name,
      updatedAt: _patchMap.containsKey(FacetValueTranslation$.updatedAt)
          ? (_patchMap[FacetValueTranslation$.updatedAt] is Function)
                ? _patchMap[FacetValueTranslation$.updatedAt](this.updatedAt)
                : (_patchMap[FacetValueTranslation$.updatedAt] is Patch)
                ? _patchMap[FacetValueTranslation$.updatedAt].applyTo(
                    this.updatedAt,
                  )
                : _patchMap[FacetValueTranslation$.updatedAt]
          : this.updatedAt,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is FacetValueTranslation &&
  ...
  Map<String, dynamic> toJsonLean() {
    final Map<String, dynamic> data = _$FacetValueTranslationToJson(this);
...
extension FacetValueTranslationPropertyHelpers on FacetValueTranslation {
...
extension FacetValueTranslationSerialization on FacetValueTranslation {
  Map<String, dynamic> toJson() {
    return _$FacetValueTranslationToJson(this);
  }
}

enum FacetValueTranslation$ { createdAt, id, languageCode, name_, updatedAt }

class FacetValueTranslationPatch
    extends PatchBase<FacetValueTranslation, FacetValueTranslation$> {
  FacetValueTranslation applyTo(FacetValueTranslation entity) {
    return entity.patchWithFacetValueTranslation(this);
  }

  FacetValueTranslationPatch withCreatedAt(DateTime? value) {
    patchMap[FacetValueTranslation$.createdAt] = value;
    return this;
  }

  FacetValueTranslationPatch withId(String? value) {
    patchMap[FacetValueTranslation$.id] = value;
    return this;
  }

  FacetValueTranslationPatch withLanguageCode(LanguageCode? value) {
    patchMap[FacetValueTranslation$.languageCode] = value;
    return this;
  }

  FacetValueTranslationPatch withName(String? value) {
    patchMap[FacetValueTranslation$.name_] = value;
    return this;
  }

  FacetValueTranslationPatch withUpdatedAt(DateTime? value) {
    patchMap[FacetValueTranslation$.updatedAt] = value;
    return this;
  }
}

/// Field descriptors for [FacetValueTranslation] query construction
abstract final class FacetValueTranslationFields {
  static const createdAt = Field<FacetValueTranslation, DateTime?>(
    'createdAt',
    _$createdAt,
  );

  static const id = Field<FacetValueTranslation, String?>('id', _$id);

  static const languageCode = Field<FacetValueTranslation, LanguageCode?>(
    'languageCode',
    _$languageCode,
  );

  static const name = Field<FacetValueTranslation, String?>('name', _$name);

  static const updatedAt = Field<FacetValueTranslation, DateTime?>(
    'updatedAt',
    _$updatedAt,
  );

  static DateTime? _$createdAt(FacetValueTranslation e) {
    return e.createdAt;
  }

  static String? _$id(FacetValueTranslation e) {
    return e.id;
  }

  static LanguageCode? _$languageCode(FacetValueTranslation e) {
    return e.languageCode;
  }

  static String? _$name(FacetValueTranslation e) {
    return e.name;
  }

  static DateTime? _$updatedAt(FacetValueTranslation e) {
    return e.updatedAt;
  }
}

extension FacetValueTranslationCompareE on FacetValueTranslation {
  Map<String, dynamic> compareToFacetValueTranslation(
    FacetValueTranslation other,
  ) {
