...
FacetValue _$FacetValueFromJson(Map json) => $checkedCreate(
  'FacetValue',
  json,
  ($checkedConvert) {
    final val = FacetValue(
      ...
      facetId: $checkedConvert('facetId', (v) => v as String?),
      ...
      translations: $checkedConvert(
        ...
        (v) => (v as List<dynamic>?)
            ?.map(
              (e) => FacetValueTranslation.fromJson(
      ...
      facet: $checkedConvert(
        'facet',
        (v) => v == null
            ? null
            : Facet.fromJson(Map<String, dynamic>.from(v as Map)),
      ),
    );
    return val;
  },
