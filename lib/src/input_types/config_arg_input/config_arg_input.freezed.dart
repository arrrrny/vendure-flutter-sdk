...
mixin _$ConfigArgInput {
 ...
 String get name;/// A JSON stringified representation of the actual value
 String get value;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ConfigArgInput&&(identical(other.name, name) || other.name == name)&&(identical(other.value, value) || other.value == value));
}
...
class _ConfigArgInput extends ConfigArgInput {
  const _ConfigArgInput({required this.name, required this.value}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ConfigArgInput&&(identical(other.name, name) || other.name == name)&&(identical(other.value, value) || other.value == value));
}
