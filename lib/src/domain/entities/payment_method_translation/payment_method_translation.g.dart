...
PaymentMethodTranslation _$PaymentMethodTranslationFromJson(Map json) =>
    $checkedCreate('PaymentMethodTranslation', json, ($checkedConvert) {
      final val = PaymentMethodTranslation(
...
Map<String, dynamic> _$PaymentMethodTranslationToJson(
  PaymentMethodTranslation instance,
) => <String, dynamic>{
