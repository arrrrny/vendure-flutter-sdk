...
class IneligiblePaymentMethodError extends AddPaymentToOrderResult {
  const IneligiblePaymentMethodError({this.eligibilityCheckerMessage, this.errorCode, this.message, final  String? $type}): $type = $type ?? 'ineligiblePaymentMethodError',super._();
...
/// Create a copy of AddPaymentToOrderResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? eligibilityCheckerMessage = freezed,Object? errorCode = freezed,Object? message = freezed,}) {
...
class OrderPaymentStateError extends AddPaymentToOrderResult {
  const OrderPaymentStateError({this.errorCode, this.message, final  String? $type}): $type = $type ?? 'orderPaymentStateError',super._();
...
class OrderStateTransitionError extends AddPaymentToOrderResult {
  const OrderStateTransitionError({this.errorCode, this.fromState, this.message, this.toState, this.transitionError, final  String? $type}): $type = $type ?? 'orderStateTransitionError',super._();
...
/// Create a copy of AddPaymentToOrderResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? errorCode = freezed,Object? fromState = freezed,Object? message = freezed,Object? toState = freezed,Object? transitionError = freezed,}) {
...
class PaymentDeclinedError extends AddPaymentToOrderResult {
  const PaymentDeclinedError({this.errorCode, this.message, this.paymentErrorMessage, final  String? $type}): $type = $type ?? 'paymentDeclinedError',super._();
...
/// Create a copy of AddPaymentToOrderResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? errorCode = freezed,Object? message = freezed,Object? paymentErrorMessage = freezed,}) {
...
class PaymentFailedError extends AddPaymentToOrderResult {
  const PaymentFailedError({this.errorCode, this.message, this.paymentErrorMessage, final  String? $type}): $type = $type ?? 'paymentFailedError',super._();
