...
as List<Promotion>,totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _PromotionList extends PromotionList {
  const _PromotionList({required final  List<Promotion> items, required this.totalItems}): _items = items,super._();
