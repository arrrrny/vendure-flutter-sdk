...
class CouponCodeExpiredError extends ApplyCouponCodeResult {
  const CouponCodeExpiredError({required this.couponCode, required this.errorCode, required this.message, final  String? $type}): $type = $type ?? 'couponCodeExpiredError',super._();
...
/// Create a copy of ApplyCouponCodeResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? couponCode = null,Object? errorCode = null,Object? message = null,}) {
...
class CouponCodeInvalidError extends ApplyCouponCodeResult {
  const CouponCodeInvalidError({required this.couponCode, required this.errorCode, required this.message, final  String? $type}): $type = $type ?? 'couponCodeInvalidError',super._();
...
class CouponCodeLimitError extends ApplyCouponCodeResult {
  const CouponCodeLimitError({required this.couponCode, required this.errorCode, required this.limit, required this.message, final  String? $type}): $type = $type ?? 'couponCodeLimitError',super._();
...
/// Create a copy of ApplyCouponCodeResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? couponCode = null,Object? errorCode = null,Object? limit = null,Object? message = null,}) {
