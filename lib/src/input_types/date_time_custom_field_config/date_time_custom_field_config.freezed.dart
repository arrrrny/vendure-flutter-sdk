...
mixin _$DateTimeCustomFieldConfig {
 ...
 List<LocalizedString?>? get description; bool? get internal; List<LocalizedString?>? get label; bool? get list; String? get max; String? get min; String? get name; bool? get nullable; bool? get readonly; List<Permission?>? get requiresPermission; int? get step; String? get type; Map<String, dynamic>? get ui;
/// Create a copy of DateTimeCustomFieldConfig
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DateTimeCustomFieldConfigCopyWith<DateTimeCustomFieldConfig> get copyWith => _$DateTimeCustomFieldConfigCopyWithImpl<DateTimeCustomFieldConfig>(this as DateTimeCustomFieldConfig, _$identity);
...
/// @nodoc
abstract mixin class $DateTimeCustomFieldConfigCopyWith<$Res>  {
...
/// Adds pattern-matching-related methods to [DateTimeCustomFieldConfig].
extension DateTimeCustomFieldConfigPatterns on DateTimeCustomFieldConfig {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _DateTimeCustomFieldConfig value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _DateTimeCustomFieldConfig() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _DateTimeCustomFieldConfig value)  $default,){
final _that = this;
switch (_that) {
case _DateTimeCustomFieldConfig():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _DateTimeCustomFieldConfig value)?  $default,){
final _that = this;
switch (_that) {
case _DateTimeCustomFieldConfig() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<LocalizedString?>? description,  bool? internal,  List<LocalizedString?>? label,  bool? list,  String? max,  String? min,  String? name,  bool? nullable,  bool? readonly,  List<Permission?>? requiresPermission,  int? step,  String? type,  Map<String, dynamic>? ui)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DateTimeCustomFieldConfig() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<LocalizedString?>? description,  bool? internal,  List<LocalizedString?>? label,  bool? list,  String? max,  String? min,  String? name,  bool? nullable,  bool? readonly,  List<Permission?>? requiresPermission,  int? step,  String? type,  Map<String, dynamic>? ui)  $default,) {final _that = this;
switch (_that) {
case _DateTimeCustomFieldConfig():
return $default(_that.description,_that.internal,_that.label,_that.list,_that.max,_that.min,_that.name,_that.nullable,_that.readonly,_that.requiresPermission,_that.step,_that.type,_that.ui);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<LocalizedString?>? description,  bool? internal,  List<LocalizedString?>? label,  bool? list,  String? max,  String? min,  String? name,  bool? nullable,  bool? readonly,  List<Permission?>? requiresPermission,  int? step,  String? type,  Map<String, dynamic>? ui)?  $default,) {final _that = this;
switch (_that) {
case _DateTimeCustomFieldConfig() when $default != null:
return $default(_that.description,_that.internal,_that.label,_that.list,_that.max,_that.min,_that.name,_that.nullable,_that.readonly,_that.requiresPermission,_that.step,_that.type,_that.ui);case _:
  return null;
...
class _DateTimeCustomFieldConfig extends DateTimeCustomFieldConfig {
  const _DateTimeCustomFieldConfig({final  List<LocalizedString?>? description, this.internal, final  List<LocalizedString?>? label, this.list, this.max, this.min, this.name, this.nullable, this.readonly, final  List<Permission?>? requiresPermission, this.step, this.type, final  Map<String, dynamic>? ui}): _description = description,_label = label,_requiresPermission = requiresPermission,_ui = ui,super._();
  factory _DateTimeCustomFieldConfig.fromJson(Map<String, dynamic> json) => _$DateTimeCustomFieldConfigFromJson(json);
...
@pragma('vm:prefer-inline')
_$DateTimeCustomFieldConfigCopyWith<_DateTimeCustomFieldConfig> get copyWith => __$DateTimeCustomFieldConfigCopyWithImpl<_DateTimeCustomFieldConfig>(this, _$identity);
...
/// @nodoc
abstract mixin class _$DateTimeCustomFieldConfigCopyWith<$Res> implements $DateTimeCustomFieldConfigCopyWith<$Res> {
  factory _$DateTimeCustomFieldConfigCopyWith(_DateTimeCustomFieldConfig value, $Res Function(_DateTimeCustomFieldConfig) _then) = __$DateTimeCustomFieldConfigCopyWithImpl;
@override @useResult
$Res call({
 List<LocalizedString?>? description, bool? internal, List<LocalizedString?>? label, bool? list, String? max, String? min, String? name, bool? nullable, bool? readonly, List<Permission?>? requiresPermission, int? step, String? type, Map<String, dynamic>? ui
});
...
/// @nodoc
class __$DateTimeCustomFieldConfigCopyWithImpl<$Res>
    implements _$DateTimeCustomFieldConfigCopyWith<$Res> {
  __$DateTimeCustomFieldConfigCopyWithImpl(this._self, this._then);

  final _DateTimeCustomFieldConfig _self;
  final $Res Function(_DateTimeCustomFieldConfig) _then;

/// Create a copy of DateTimeCustomFieldConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? description = freezed,Object? internal = freezed,Object? label = freezed,Object? list = freezed,Object? max = freezed,Object? min = freezed,Object? name = freezed,Object? nullable = freezed,Object? readonly = freezed,Object? requiresPermission = freezed,Object? step = freezed,Object? type = freezed,Object? ui = freezed,}) {
  return _then(_DateTimeCustomFieldConfig(
