...
ProductTranslation _$ProductTranslationFromJson(Map json) =>
    $checkedCreate('ProductTranslation', json, ($checkedConvert) {
      final val = ProductTranslation(
...
Map<String, dynamic> _$ProductTranslationToJson(ProductTranslation instance) =>
    <String, dynamic>{
