...
as List<Province?>?,totalItems: freezed == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
class _ProvinceList extends ProvinceList {
  const _ProvinceList({final  List<Province?>? items, this.totalItems}): _items = items,super._();
