...
/// Create a copy of DeletionResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? message = freezed,Object? result = null,}) {
...
class _DeletionResponse extends DeletionResponse {
  const _DeletionResponse({this.message, required this.result}): super._();
...
/// Create a copy of DeletionResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? message = freezed,Object? result = null,}) {
