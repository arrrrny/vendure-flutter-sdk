...
class _CreateAddressInput extends CreateAddressInput {
   _CreateAddressInput({this.city, this.company, required this.countryCode, this.customFields, this.defaultBillingAddress, this.defaultShippingAddress, this.fullName, this.phoneNumber, this.postalCode, this.province, required this.streetLine1, this.streetLine2}): super._();
