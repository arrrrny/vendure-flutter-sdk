...
class PriceRange extends SearchResultPrice {
  const PriceRange({required this.max, required this.min, final  String? $type}): $type = $type ?? 'priceRange',super._();
...
/// Create a copy of SearchResultPrice
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? max = null,Object? min = null,}) {
...
class SinglePrice extends SearchResultPrice {
  const SinglePrice({required this.value, final  String? $type}): $type = $type ?? 'singlePrice',super._();
