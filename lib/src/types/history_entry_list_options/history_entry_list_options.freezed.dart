...
/// Allows the results to be filtered
 HistoryEntryFilterParameter? get filter;/// Allows the results to be filtered
 set filter(HistoryEntryFilterParameter? value);/// Specifies whether multiple top-level "filter" fields should be combined with a
...
/// logical AND or OR operation. Defaults to AND.
 ...
 HistoryEntrySortParameter? get sort;/// Specifies which properties to sort the results by
 set sort(HistoryEntrySortParameter? value);/// Takes n results, for use in pagination
...
class _HistoryEntryListOptions extends HistoryEntryListOptions {
   _HistoryEntryListOptions({this.filter, this.filterOperator, this.skip, this.sort, this.take}): super._();
  factory _HistoryEntryListOptions.fromJson(Map<String, dynamic> json) => _$HistoryEntryListOptionsFromJson(json);

/// Allows the results to be filtered
@override  HistoryEntryFilterParameter? filter;
...
@override  HistoryEntrySortParameter? sort;
