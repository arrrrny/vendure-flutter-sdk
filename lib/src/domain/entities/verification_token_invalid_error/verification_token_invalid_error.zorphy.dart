...
class VerificationTokenInvalidError {
  ...
  VerificationTokenInvalidError copyWith({
    ErrorCode? errorCode,
    String? message,
  }) {
  ...
  VerificationTokenInvalidError copyWithVerificationTokenInvalidError({
    ErrorCode? errorCode,
    String? message,
  }) {
  ...
  VerificationTokenInvalidError patchWithVerificationTokenInvalidError([
    VerificationTokenInvalidErrorPatch? patchInput,
  ]) {
    final _patcher = patchInput ?? VerificationTokenInvalidErrorPatch();
    final _patchMap = _patcher.patchMap;
    return VerificationTokenInvalidError(
      errorCode: _patchMap.containsKey(VerificationTokenInvalidError$.errorCode)
          ? (_patchMap[VerificationTokenInvalidError$.errorCode] is Function)
                ? _patchMap[VerificationTokenInvalidError$.errorCode](
                    this.errorCode,
                  )
                : (_patchMap[VerificationTokenInvalidError$.errorCode] is Patch)
                ? _patchMap[VerificationTokenInvalidError$.errorCode].applyTo(
                    this.errorCode,
                  )
                : _patchMap[VerificationTokenInvalidError$.errorCode]
          : this.errorCode,
      message: _patchMap.containsKey(VerificationTokenInvalidError$.message)
          ? (_patchMap[VerificationTokenInvalidError$.message] is Function)
                ? _patchMap[VerificationTokenInvalidError$.message](
                    this.message,
                  )
                : (_patchMap[VerificationTokenInvalidError$.message] is Patch)
                ? _patchMap[VerificationTokenInvalidError$.message].applyTo(
                    this.message,
                  )
                : _patchMap[VerificationTokenInvalidError$.message]
          : this.message,
  ...
  bool operator ==(Object other) {
    ...
    return other is VerificationTokenInvalidError &&
  ...
  Map<String, dynamic> toJsonLean() {
    final Map<String, dynamic> data = _$VerificationTokenInvalidErrorToJson(
      this,
    );
...
extension VerificationTokenInvalidErrorPropertyHelpers
...
extension VerificationTokenInvalidErrorSerialization
    on VerificationTokenInvalidError {
...
enum VerificationTokenInvalidError$ { errorCode, message }

class VerificationTokenInvalidErrorPatch
    extends
        PatchBase<
          VerificationTokenInvalidError,
          VerificationTokenInvalidError$
        > {
  VerificationTokenInvalidError applyTo(VerificationTokenInvalidError entity) {
    return entity.patchWithVerificationTokenInvalidError(this);
  }

  VerificationTokenInvalidErrorPatch withErrorCode(ErrorCode? value) {
    patchMap[VerificationTokenInvalidError$.errorCode] = value;
    return this;
  }

  VerificationTokenInvalidErrorPatch withMessage(String? value) {
    patchMap[VerificationTokenInvalidError$.message] = value;
    return this;
  }
}

/// Field descriptors for [VerificationTokenInvalidError] query construction
abstract final class VerificationTokenInvalidErrorFields {
  static const errorCode = Field<VerificationTokenInvalidError, ErrorCode?>(
    'errorCode',
    _$errorCode,
  );

  static const message = Field<VerificationTokenInvalidError, String?>(
    'message',
    _$message,
  );

  static ErrorCode? _$errorCode(VerificationTokenInvalidError e) {
    return e.errorCode;
  }

  static String? _$message(VerificationTokenInvalidError e) {
    return e.message;
  }
}

extension VerificationTokenInvalidErrorCompareE
    on VerificationTokenInvalidError {
  Map<String, dynamic> compareToVerificationTokenInvalidError(
    VerificationTokenInvalidError other,
  ) {
