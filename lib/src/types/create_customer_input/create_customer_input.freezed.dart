...
mixin _$CreateCustomerInput {
 ...
 Map<String, dynamic>? get customFields; set customFields(Map<String, dynamic>? value); String get emailAddress; set emailAddress(String value); String get firstName; set firstName(String value); String get lastName; set lastName(String value); String? get phoneNumber; set phoneNumber(String? value); String? get title; set title(String? value);
...
class _CreateCustomerInput extends CreateCustomerInput {
   _CreateCustomerInput({this.customFields, required this.emailAddress, required this.firstName, required this.lastName, this.phoneNumber, this.title}): super._();
