...
mixin _$ConfigurableOperationInput {
 ...
 List<ConfigArgInput> get arguments; String get code;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ConfigurableOperationInput&&const DeepCollectionEquality().equals(other.arguments, arguments)&&(identical(other.code, code) || other.code == code));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(arguments),code);
...
class _ConfigurableOperationInput extends ConfigurableOperationInput {
  const _ConfigurableOperationInput({required final  List<ConfigArgInput> arguments, required this.code}): _arguments = arguments,super._();
...
@override List<ConfigArgInput> get arguments {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ConfigurableOperationInput&&const DeepCollectionEquality().equals(other._arguments, _arguments)&&(identical(other.code, code) || other.code == code));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_arguments),code);
