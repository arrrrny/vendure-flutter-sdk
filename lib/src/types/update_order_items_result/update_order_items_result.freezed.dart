...
class InsufficientStockError extends UpdateOrderItemsResult {
  const InsufficientStockError({required this.errorCode, required this.message, required this.order, required this.quantityAvailable, final  String? $type}): $type = $type ?? 'insufficientStockError',super._();
...
/// Create a copy of UpdateOrderItemsResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? errorCode = null,Object? message = null,Object? order = freezed,Object? quantityAvailable = null,}) {
...
as Order,quantityAvailable: null == quantityAvailable ? _self.quantityAvailable : quantityAvailable // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class NegativeQuantityError extends UpdateOrderItemsResult {
  const NegativeQuantityError({required this.errorCode, required this.message, final  String? $type}): $type = $type ?? 'negativeQuantityError',super._();
...
class OrderLimitError extends UpdateOrderItemsResult {
  const OrderLimitError({required this.errorCode, required this.maxItems, required this.message, final  String? $type}): $type = $type ?? 'orderLimitError',super._();
...
/// Create a copy of UpdateOrderItemsResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? errorCode = null,Object? maxItems = null,Object? message = null,}) {
